...
'set return-object
Sub SetReturnObject(varReturnObject As Boolean) As VMComboBox
	If varReturnObject = False Then
		RemoveAttr("return-object")
		Return Me
	End If
...
'set color intensity
Sub SetTextColor(varColor As String) As VMComboBox
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMComboBox
	Dim sColor As String = $"${varColor}--text"$
