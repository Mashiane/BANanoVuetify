...
Sub BuildModel(mprops As Map, mstyles As Map, lclasses As List, loose As List) As VMProgressCircle
...
'set color intensity
Sub SetTextColor(varColor As String) As VMProgressCircle
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMProgressCircle
	Dim sColor As String = $"${varColor}--text"$
