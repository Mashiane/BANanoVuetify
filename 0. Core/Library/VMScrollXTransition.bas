...
Sub SetVIf(vif As Object) As VMScrollXTransition
ScrollXTransition.SetVIf(vif)
Return Me
End Sub

Sub SetVShow(vif As Object) As VMScrollXTransition
...
'set text
Sub SetText(t As Object) As VMScrollXTransition
ScrollXTransition.SetText(t)
Return Me
End Sub
...
'set group
Sub SetGroup(varGroup As Object) As VMScrollXTransition
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Object) As VMScrollXTransition
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Object) As VMScrollXTransition
...
'set mode
Sub SetMode(varMode As Object) As VMScrollXTransition
...
'set origin
Sub SetOrigin(varOrigin As Object) As VMScrollXTransition
Dim pp As String = $"${ID}Origin"$
vue.SetStateSingle(pp, varOrigin)
ScrollXTransition.Bind(":origin", pp)
Return Me
End Sub
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VMScrollXTransition
	Dim pp As String = $"${ID}Color"$
	Dim scolor As String = $"${varColor} ${varIntensity}"$
	vue.SetStateSingle(pp, scolor)
	ScrollXTransition.Bind(":color", pp)
	Return Me
End Sub
...
'set tab index
Sub SetTabIndex(ti As String) As VMScrollXTransition
	ScrollXTransition.SetTabIndex(ti)
	Return Me
End Sub

'The Select name. Similar To HTML5 name attribute.
Sub SetName(varName As Object, bbind As Boolean) As VMScrollXTransition
...
'set color intensity
Sub SetTextColor(varColor As String) As VMScrollXTransition
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMScrollXTransition
	Dim sColor As String = $"${varColor}--text"$
