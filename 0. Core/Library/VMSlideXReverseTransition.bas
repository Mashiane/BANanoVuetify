...
'set text
Sub SetText(t As Object) As VMSlideXReverseTransition
SlideXReverseTransition.SetText(t)
Return Me
End Sub
...
'set group
Sub SetGroup(varGroup As Object) As VMSlideXReverseTransition
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Object) As VMSlideXReverseTransition
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Object) As VMSlideXReverseTransition
...
'set mode
Sub SetMode(varMode As Object) As VMSlideXReverseTransition
...
'set origin
Sub SetOrigin(varOrigin As Object) As VMSlideXReverseTransition
Dim pp As String = $"${ID}Origin"$
vue.SetStateSingle(pp, varOrigin)
SlideXReverseTransition.Bind(":origin", pp)
Return Me
End Sub
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VMSlideXReverseTransition
	Dim pp As String = $"${ID}Color"$
	Dim scolor As String = $"${varColor} ${varIntensity}"$
	vue.SetStateSingle(pp, scolor)
	SlideXReverseTransition.Bind(":color", pp)
	Return Me
End Sub
...
'set tab index
Sub SetTabIndex(ti As String) As VMSlideXReverseTransition
	SlideXReverseTransition.SetTabIndex(ti)
	Return Me
End Sub

'The Select name. Similar To HTML5 name attribute.
Sub SetName(varName As Object, bbind As Boolean) As VMSlideXReverseTransition
...
'set color intensity
Sub SetTextColor(varColor As String) As VMSlideXReverseTransition
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMSlideXReverseTransition
	Dim sColor As String = $"${varColor}--text"$
