...
#DesignerProperty: Key: Border, DisplayName: Border, FieldType: String, DefaultValue:  , Description: Puts a border on the alert. Accepts **top** \| **right** \| **bottom** \| **left**.
...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Hides the alert icon and decreases components height.
#DesignerProperty: Key: Dismissible, DisplayName: Dismissible, FieldType: Boolean, DefaultValue: False , Description: Adds a close icon that can hide the alert.
...
#DesignerProperty: Key: Icon, DisplayName: Icon, FieldType: String, DefaultValue:  , Description: Designates a specific icon.
...
#DesignerProperty: Key: Prominent, DisplayName: Prominent, FieldType: Boolean, DefaultValue: False , Description: Displays a larger vertically centered icon to draw more attention.
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Rounded, DisplayName: Rounded, FieldType: String, DefaultValue:  , Description: Designates the **border-radius** applied to the component. You can find more information on the Border Radius page/styles/border-radius.
...
#DesignerProperty: Key: Text, DisplayName: Text, FieldType: Boolean, DefaultValue: False , Description: Applies the defined **color** to text and a low opacity background of the same.
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue:  , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
#DesignerProperty: Key: TypeOf, DisplayName: TypeOf, FieldType: String, DefaultValue:  , Description: Specify a **success**, **info**, **warning** or **error** alert. Uses the contextual color and has a pre-defined icon.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: True , Description: Controls whether the component is visible or hidden.
...
Private boDismissible As Boolean = False
...
Private boProminent As Boolean = False
Private stRef As String = ""
Private stRounded As String = ""
...
Private stTransition As String = ""
Private stTypeOf As String = ""
...
Private boValue As Boolean = True
...
boDismissible = Props.Get("Dismissible")
...
boProminent = Props.Get("Prominent")
stRef = Props.Get("Ref")
stRounded = Props.Get("Rounded")
...
AddAttr("dismissible", boDismissible)
...
AddAttr("prominent", boProminent)
AddAttr("ref", stRef)
AddAttr("rounded", stRounded)
...
'set Puts a border on the alert. Accepts **top** \| **right** \| **bottom** \| **left**.
public Sub setBorder(varBorder As String)
AddAttr("border", varBorder)
stBorder = varBorder
End Sub

'get Puts a border on the alert. Accepts **top** \| **right** \| **bottom** \| **left**.
...
'set Hides the alert icon and decreases components height.
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Hides the alert icon and decreases components height.
public Sub getDense() As Boolean
Return boDense
End Sub

'set Adds a close icon that can hide the alert.
public Sub setDismissible(varDismissible As Boolean)
AddAttr("dismissible", varDismissible)
boDismissible = varDismissible
End Sub

'get Adds a close icon that can hide the alert.
public Sub getDismissible() As Boolean
Return boDismissible
End Sub
...
'set Designates a specific icon.
public Sub setIcon(varIcon As String)
AddAttr("icon", varIcon)
stIcon = varIcon
End Sub

'get Designates a specific icon.
...
'set Displays a larger vertically centered icon to draw more attention.
public Sub setProminent(varProminent As Boolean)
AddAttr("prominent", varProminent)
boProminent = varProminent
End Sub

'get Displays a larger vertically centered icon to draw more attention.
public Sub getProminent() As Boolean
Return boProminent
End Sub
...
'set Designates the **border-radius** applied to the component. You can find more information on the Border Radius page/styles/border-radius.
public Sub setRounded(varRounded As String)
AddAttr("rounded", varRounded)
stRounded = varRounded
End Sub

'get Designates the **border-radius** applied to the component. You can find more information on the Border Radius page/styles/border-radius.
...
'set Applies the defined **color** to text and a low opacity background of the same.
public Sub setText(varText As Boolean)
AddAttr("text", varText)
boText = varText
End Sub

'get Applies the defined **color** to text and a low opacity background of the same.
...
'set Specify a **success**, **info**, **warning** or **error** alert. Uses the contextual color and has a pre-defined icon.
public Sub setTypeOf(varTypeOf As String)
AddAttr("type", varTypeOf)
stTypeOf = varTypeOf
End Sub

'get Specify a **success**, **info**, **warning** or **error** alert. Uses the contextual color and has a pre-defined icon.
...
public Sub setValue(varValue As Boolean)
