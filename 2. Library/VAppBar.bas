...
#DesignerProperty: Key: Collapse, DisplayName: Collapse, FieldType: Boolean, DefaultValue: False , Description: Puts the toolbar into a collapsed state reducing its maximum width.
...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Reduces the height of the toolbar content to 48px 96px when using the **prominent** prop.
...
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Removes the toolbars box-shadow.
#DesignerProperty: Key: Floating, DisplayName: Floating, FieldType: Boolean, DefaultValue: False , Description: Applies **display: inline-flex** to the component.
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue:  , Description: Designates a specific height for the toolbar. Overrides the heights imposed by other props, e.g. **prominent**, **dense**, **extended**, etc.
...
#DesignerProperty: Key: Outlined, DisplayName: Outlined, FieldType: Boolean, DefaultValue: False , Description: Removes elevation box-shadow and adds a *thin* border.
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Prominent, DisplayName: Prominent, FieldType: Boolean, DefaultValue: False , Description: Increases the height of the toolbar content to 128px.
...
#DesignerProperty: Key: Short, DisplayName: Short, FieldType: Boolean, DefaultValue: False , Description: Reduce the height of the toolbar content to 56px 112px when using the **prominent** prop.
#DesignerProperty: Key: Src, DisplayName: Src, FieldType: String, DefaultValue:  , Description: Image source. See `v-img` for details
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: header , Description: Specify a custom tag used on the root element.
...
Private boCollapse As Boolean = False
...
Private boFloating As Boolean = False
...
Private boShort As Boolean = False
Private stSrc As String = ""
Private stTag As String = "header"
...
'set Puts the toolbar into a collapsed state reducing its maximum width.
public Sub setCollapse(varCollapse As Boolean)
AddAttr("collapse", varCollapse)
boCollapse = varCollapse
End Sub

'get Puts the toolbar into a collapsed state reducing its maximum width.
public Sub getCollapse() As Boolean
Return boCollapse
End Sub
...
'set Reduces the height of the toolbar content to 48px 96px when using the **prominent** prop.
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Reduces the height of the toolbar content to 48px 96px when using the **prominent** prop.
...
'set Removes the toolbars box-shadow.
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Removes the toolbars box-shadow.
public Sub getFlat() As Boolean
Return boFlat
End Sub

'set Applies **display: inline-flex** to the component.
public Sub setFloating(varFloating As Boolean)
AddAttr("floating", varFloating)
boFloating = varFloating
End Sub

'get Applies **display: inline-flex** to the component.
public Sub getFloating() As Boolean
Return boFloating
End Sub

'set Designates a specific height for the toolbar. Overrides the heights imposed by other props, e.g. **prominent**, **dense**, **extended**, etc.
public Sub setHeight(varHeight As String)
AddAttr("height", varHeight)
stHeight = varHeight
End Sub

'get Designates a specific height for the toolbar. Overrides the heights imposed by other props, e.g. **prominent**, **dense**, **extended**, etc.
...
'set Removes elevation box-shadow and adds a *thin* border.
public Sub setOutlined(varOutlined As Boolean)
AddAttr("outlined", varOutlined)
boOutlined = varOutlined
End Sub

'get Removes elevation box-shadow and adds a *thin* border.
...
'set Increases the height of the toolbar content to 128px.
public Sub setProminent(varProminent As Boolean)
AddAttr("prominent", varProminent)
boProminent = varProminent
End Sub

'get Increases the height of the toolbar content to 128px.
...
'set Reduce the height of the toolbar content to 56px 112px when using the **prominent** prop.
public Sub setShort(varShort As Boolean)
AddAttr("short", varShort)
boShort = varShort
End Sub

'get Reduce the height of the toolbar content to 56px 112px when using the **prominent** prop.
public Sub getShort() As Boolean
Return boShort
End Sub

'set Image source. See `v-img` for details
public Sub setSrc(varSrc As String)
AddAttr("src", varSrc)
stSrc = varSrc
End Sub

'get Image source. See `v-img` for details
