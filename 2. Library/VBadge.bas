...
#DesignerProperty: Key: Avatar, DisplayName: Avatar, FieldType: Boolean, DefaultValue: False , Description: Removes badge padding for the use of the `v-avatar` in the **badge** slot.
#DesignerProperty: Key: Bordered, DisplayName: Bordered, FieldType: Boolean, DefaultValue: False , Description: Applies a **2px** by default and **1.5px** border around the badge when using the **dot** property.
...
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: primary , Description: Applies specified color to the control - it can be the name of material color for example `success` or `purple` or css color `#033` or `rgba255, 0, 0, 0.5`. You can find list of built in classes on the colors page/styles/colors#material-colors.
#DesignerProperty: Key: Content, DisplayName: Content, FieldType: String, DefaultValue:  , Description: Any content you want injected as text into the badge.
...
#DesignerProperty: Key: Dot, DisplayName: Dot, FieldType: Boolean, DefaultValue: False , Description: Reduce the size of the badge and hide its contents
#DesignerProperty: Key: Icon, DisplayName: Icon, FieldType: String, DefaultValue:  , Description: Designates a specific icon used in the badge.
#DesignerProperty: Key: Inline, DisplayName: Inline, FieldType: Boolean, DefaultValue: False , Description: Moves the badge to be inline with the wrapping element. Supports the usage of the **left** prop.
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Label, DisplayName: Label, FieldType: String, DefaultValue: $vuetify.badge , Description: The **aria-label** used for the badge
#DesignerProperty: Key: Left, DisplayName: Left, FieldType: Boolean, DefaultValue: False , Description: Aligns the component towards the left.
...
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue:  , Description: Sets the transition mode does not apply to transition-group. You can find more information on the Vue documentation for transition modeshttps://vuejs.org/v2/api/#transition.
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue:  , Description: Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
#DesignerProperty: Key: Overlap, DisplayName: Overlap, FieldType: Boolean, DefaultValue: False , Description: Overlaps the slotted content on top of the component.
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: scale-rotate-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: true , Description: Controls whether the component is visible or hidden.
'***** STYLES *****
...
Private boAvatar As Boolean = False
Private boBordered As Boolean = False
Private boBottom As Boolean = False
Private stColor As String = "primary"
Private stContent As String = ""
Private boDark As Boolean = False
Private boDot As Boolean = False
Private stIcon As String = ""
Private boInline As Boolean = False
Private stKey As String = ""
Private stLabel As String = "$vuetify.badge"
Private boLeft As Boolean = False
Private boLight As Boolean = False
Private stMode As String = ""
Private stOrigin As String = ""
Private boOverlap As Boolean = False
Private stParentId As String = ""
Private stRef As String = ""
Private boTile As Boolean = False
Private stTransition As String = "scale-rotate-transition"
...
Private stValue As String = "true"
...
boAvatar = Props.Get("Avatar")
boBordered = Props.Get("Bordered")
boBottom = Props.Get("Bottom")
stColor = Props.Get("Color")
stContent = Props.Get("Content")
boDark = Props.Get("Dark")
boDot = Props.Get("Dot")
stIcon = Props.Get("Icon")
boInline = Props.Get("Inline")
stKey = Props.Get("Key")
stLabel = Props.Get("Label")
boLeft = Props.Get("Left")
boLight = Props.Get("Light")
stMode = Props.Get("Mode")
stOrigin = Props.Get("Origin")
boOverlap = Props.Get("Overlap")
stParentId = Props.Get("ParentId")
stRef = Props.Get("Ref")
boTile = Props.Get("Tile")
stTransition = Props.Get("Transition")
...
AddAttr("avatar", boAvatar)
AddAttr("bordered", boBordered)
AddAttr("bottom", boBottom)
AddAttr("color", stColor)
AddAttr("content", stContent)
AddAttr("dark", boDark)
AddAttr("dot", boDot)
AddAttr("icon", stIcon)
AddAttr("inline", boInline)
AddAttr("key", stKey)
AddAttr("label", stLabel)
AddAttr("left", boLeft)
AddAttr("light", boLight)
AddAttr("mode", stMode)
AddAttr("origin", stOrigin)
AddAttr("overlap", boOverlap)
AddAttr("parent-id", stParentId)
AddAttr("ref", stRef)
AddAttr("tile", boTile)
AddAttr("transition", stTransition)
...
'set Removes badge padding for the use of the `v-avatar` in the **badge** slot.
public Sub setAvatar(varAvatar As Boolean)
AddAttr("avatar", varAvatar)
boAvatar = varAvatar
End Sub

'get Removes badge padding for the use of the `v-avatar` in the **badge** slot.
public Sub getAvatar() As Boolean
Return boAvatar
End Sub

'set Applies a **2px** by default and **1.5px** border around the badge when using the **dot** property.
public Sub setBordered(varBordered As Boolean)
AddAttr("bordered", varBordered)
boBordered = varBordered
End Sub

'get Applies a **2px** by default and **1.5px** border around the badge when using the **dot** property.
public Sub getBordered() As Boolean
Return boBordered
End Sub
...
'set Any content you want injected as text into the badge.
public Sub setContent(varContent As String)
AddAttr("content", varContent)
stContent = varContent
End Sub

'get Any content you want injected as text into the badge.
...
'set Reduce the size of the badge and hide its contents
public Sub setDot(varDot As Boolean)
AddAttr("dot", varDot)
boDot = varDot
End Sub

'get Reduce the size of the badge and hide its contents
public Sub getDot() As Boolean
Return boDot
End Sub

'set Designates a specific icon used in the badge.
public Sub setIcon(varIcon As String)
AddAttr("icon", varIcon)
stIcon = varIcon
End Sub

'get Designates a specific icon used in the badge.
public Sub getIcon() As String
Return stIcon
End Sub

'set Moves the badge to be inline with the wrapping element. Supports the usage of the **left** prop.
public Sub setInline(varInline As Boolean)
AddAttr("inline", varInline)
boInline = varInline
End Sub

'get Moves the badge to be inline with the wrapping element. Supports the usage of the **left** prop.
public Sub getInline() As Boolean
Return boInline
End Sub
...
'set The **aria-label** used for the badge
public Sub setLabel(varLabel As String)
AddAttr("label", varLabel)
stLabel = varLabel
End Sub

'get The **aria-label** used for the badge
public Sub getLabel() As String
Return stLabel
End Sub

'set Aligns the component towards the left.
public Sub setLeft(varLeft As Boolean)
AddAttr("left", varLeft)
boLeft = varLeft
End Sub

'get Aligns the component towards the left.
...
'set Sets the transition mode does not apply to transition-group. You can find more information on the Vue documentation for transition modeshttps://vuejs.org/v2/api/#transition.
public Sub setMode(varMode As String)
AddAttr("mode", varMode)
stMode = varMode
End Sub

'get Sets the transition mode does not apply to transition-group. You can find more information on the Vue documentation for transition modeshttps://vuejs.org/v2/api/#transition.
public Sub getMode() As String
Return stMode
End Sub

'set Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
public Sub setOrigin(varOrigin As String)
AddAttr("origin", varOrigin)
stOrigin = varOrigin
End Sub

'get Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
public Sub getOrigin() As String
Return stOrigin
End Sub

'set Overlaps the slotted content on top of the component.
public Sub setOverlap(varOverlap As Boolean)
AddAttr("overlap", varOverlap)
boOverlap = varOverlap
End Sub

'get Overlaps the slotted content on top of the component.
public Sub getOverlap() As Boolean
Return boOverlap
End Sub
...
'set Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
public Sub setTransition(varTransition As String)
AddAttr("transition", varTransition)
stTransition = varTransition
End Sub

'get Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
public Sub getTransition() As String
Return stTransition
End Sub
