...
#DesignerProperty: Key: App, DisplayName: App, FieldType: Boolean, DefaultValue: False , Description: When used inside of `v-main`, will calculate top based upon application `v-toolbar` and `v-system-bar`.
...
#DesignerProperty: Key: Sticky, DisplayName: Sticky, FieldType: Boolean, DefaultValue: False , Description: Applies **position: sticky** to the component **Evergreen browsers only**. You can find more information on the MDN documentation for sticky positionhttps://developer.mozilla.org/en-US/docs/Web/CSS/position.
...
Private boSticky As Boolean = False
...
'set When used inside of `v-main`, will calculate top based upon application `v-toolbar` and `v-system-bar`.
public Sub setApp(varApp As Boolean)
AddAttr("app", varApp)
boApp = varApp
End Sub

'get When used inside of `v-main`, will calculate top based upon application `v-toolbar` and `v-system-bar`.
...
'set Applies **position: sticky** to the component **Evergreen browsers only**. You can find more information on the MDN documentation for sticky positionhttps://developer.mozilla.org/en-US/docs/Web/CSS/position.
public Sub setSticky(varSticky As Boolean)
AddAttr("sticky", varSticky)
boSticky = varSticky
End Sub

'get Applies **position: sticky** to the component **Evergreen browsers only**. You can find more information on the MDN documentation for sticky positionhttps://developer.mozilla.org/en-US/docs/Web/CSS/position.
public Sub getSticky() As Boolean
Return boSticky
End Sub
