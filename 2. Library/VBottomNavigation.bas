...
#DesignerProperty: Key: Grow, DisplayName: Grow, FieldType: Boolean, DefaultValue: False , Description: Force v-btn/components/buttonss to take up all available space.
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 56 , Description: Sets the height for the component.
#DesignerProperty: Key: Horizontal, DisplayName: Horizontal, FieldType: Boolean, DefaultValue: False , Description: Uses an alternative horizontal styling for v-btn/components/buttons.
...
#DesignerProperty: Key: Shift, DisplayName: Shift, FieldType: Boolean, DefaultValue: False , Description: Hides text of v-btn/components/buttonss when they are not active.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Holds the value of the currently active v-btn/components/buttons. If the button has no value supplied, its index will be used instead..
...
Private boShift As Boolean = False
...
'set Force v-btn/components/buttonss to take up all available space.
public Sub setGrow(varGrow As Boolean)
AddAttr("grow", varGrow)
boGrow = varGrow
End Sub

'get Force v-btn/components/buttonss to take up all available space.
...
'set Uses an alternative horizontal styling for v-btn/components/buttons.
public Sub setHorizontal(varHorizontal As Boolean)
AddAttr("horizontal", varHorizontal)
boHorizontal = varHorizontal
End Sub

'get Uses an alternative horizontal styling for v-btn/components/buttons.
...
'set Hides text of v-btn/components/buttonss when they are not active.
public Sub setShift(varShift As Boolean)
AddAttr("shift", varShift)
boShift = varShift
End Sub

'get Hides text of v-btn/components/buttonss when they are not active.
public Sub getShift() As Boolean
Return boShift
End Sub
...
'set Holds the value of the currently active v-btn/components/buttons. If the button has no value supplied, its index will be used instead..
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Holds the value of the currently active v-btn/components/buttons. If the button has no value supplied, its index will be used instead..
