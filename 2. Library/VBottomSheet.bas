...
#DesignerProperty: Key: Activator, DisplayName: Activator, FieldType: String, DefaultValue:  , Description: Designate a custom activator when the `activator` slot is not used. String can be any valid querySelector and Object can be any valid Node.
...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables the ability to open the component.
...
#DesignerProperty: Key: Fullscreen, DisplayName: Fullscreen, FieldType: Boolean, DefaultValue: False , Description: Changes layout for fullscreen display.
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: Reduces the sheet content maximum width to 70%.
...
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue: center center , Description: Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Persistent, DisplayName: Persistent, FieldType: Boolean, DefaultValue: False , Description: Clicking outside of the element will not deactivate it.
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Scrollable, DisplayName: Scrollable, FieldType: Boolean, DefaultValue: False , Description: When set to true, expects a `v-card` and a `v-card-text` component with a designated height. For more information, check out the scrollable example/components/dialogs#scrollable.
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: bottom-sheet-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: auto , Description: Sets the width for the component.
'***** STYLES *****
...
Private stWidth As String = "auto"
...
'set Designate a custom activator when the `activator` slot is not used. String can be any valid querySelector and Object can be any valid Node.
public Sub setActivator(varActivator As String)
AddAttr("activator", varActivator)
stActivator = varActivator
End Sub

'get Designate a custom activator when the `activator` slot is not used. String can be any valid querySelector and Object can be any valid Node.
public Sub getActivator() As String
Return stActivator
End Sub
...
'set Changes layout for fullscreen display.
public Sub setFullscreen(varFullscreen As Boolean)
AddAttr("fullscreen", varFullscreen)
boFullscreen = varFullscreen
End Sub

'get Changes layout for fullscreen display.
public Sub getFullscreen() As Boolean
Return boFullscreen
End Sub

'set Reduces the sheet content maximum width to 70%.
public Sub setInset(varInset As Boolean)
AddAttr("inset", varInset)
boInset = varInset
End Sub

'get Reduces the sheet content maximum width to 70%.
public Sub getInset() As Boolean
Return boInset
End Sub
...
'set Clicking outside of the element will not deactivate it.
public Sub setPersistent(varPersistent As Boolean)
AddAttr("persistent", varPersistent)
boPersistent = varPersistent
End Sub

'get Clicking outside of the element will not deactivate it.
public Sub getPersistent() As Boolean
Return boPersistent
End Sub
...
'set When set to true, expects a `v-card` and a `v-card-text` component with a designated height. For more information, check out the scrollable example/components/dialogs#scrollable.
public Sub setScrollable(varScrollable As Boolean)
AddAttr("scrollable", varScrollable)
boScrollable = varScrollable
End Sub

'get When set to true, expects a `v-card` and a `v-card-text` component with a designated height. For more information, check out the scrollable example/components/dialogs#scrollable.
