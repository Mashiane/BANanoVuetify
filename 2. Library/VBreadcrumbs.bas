...
#DesignerProperty: Key: Divider, DisplayName: Divider, FieldType: String, DefaultValue: / , Description: Specifies the dividing character between items.
#DesignerProperty: Key: Items, DisplayName: Items, FieldType: String, DefaultValue:  , Description: An array of objects for each breadcrumb.
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Large, DisplayName: Large, FieldType: Boolean, DefaultValue: False , Description: Increase the font-size of the breadcrumb item text to 16px 14px default.
...
'set Specifies the dividing character between items.
public Sub setDivider(varDivider As String)
AddAttr("divider", varDivider)
stDivider = varDivider
End Sub

'get Specifies the dividing character between items.
public Sub getDivider() As String
Return stDivider
End Sub

'set An array of objects for each breadcrumb.
public Sub setItems(varItems As String)
AddAttr("items", varItems)
stItems = varItems
End Sub

'get An array of objects for each breadcrumb.
...
'set Increase the font-size of the breadcrumb item text to 16px 14px default.
public Sub setLarge(varLarge As Boolean)
AddAttr("large", varLarge)
boLarge = varLarge
End Sub

'get Increase the font-size of the breadcrumb item text to 16px 14px default.
