...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: String, DefaultValue: false , Description: Applies the v-ripple/directives/ripple directive.
...
Private stRipple As String = "false"
