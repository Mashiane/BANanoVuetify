...
#DesignerProperty: Key: Borderless, DisplayName: Borderless, FieldType: Boolean, DefaultValue: False , Description: Removes the groups border.
...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Reduces the button size and padding.
#DesignerProperty: Key: Group, DisplayName: Group, FieldType: Boolean, DefaultValue: False , Description: Generally used in v-toolbar/components/toolbars and v-app-bar/components/app-bars. Removes background color, border and increases space between the buttons
...
#DesignerProperty: Key: Rounded, DisplayName: Rounded, FieldType: Boolean, DefaultValue: False , Description: Round edge buttons
...
AddAttr("borderless", boBorderless)
AddAttr("color", stColor)
AddAttr("dark", boDark)
AddAttr("dense", boDense)
AddAttr("group", boGroup)
AddAttr("key", stKey)
...
'set Removes the groups border.
public Sub setBorderless(varBorderless As Boolean)
AddAttr("borderless", varBorderless)
boBorderless = varBorderless
End Sub

'get Removes the groups border.
public Sub getBorderless() As Boolean
Return boBorderless
End Sub
...
'set Reduces the button size and padding.
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Reduces the button size and padding.
public Sub getDense() As Boolean
Return boDense
End Sub

'set Generally used in v-toolbar/components/toolbars and v-app-bar/components/app-bars. Removes background color, border and increases space between the buttons
public Sub setGroup(varGroup As Boolean)
AddAttr("group", varGroup)
boGroup = varGroup
End Sub

'get Generally used in v-toolbar/components/toolbars and v-app-bar/components/app-bars. Removes background color, border and increases space between the buttons
public Sub getGroup() As Boolean
Return boGroup
End Sub
