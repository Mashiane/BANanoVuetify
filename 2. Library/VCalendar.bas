...
#DesignerProperty: Key: End, DisplayName: End, FieldType: String, DefaultValue:  , Description: The ending date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
#DesignerProperty: Key: Events, DisplayName: Events, FieldType: String, DefaultValue:  , Description: An array of event objects with a property for a start timestamp and optionally a name and end timestamp. If an end timestamp is not given, the value of start will be used. If no name is given, you must provide an implementation for the `event` slot.
...
#DesignerProperty: Key: Locale, DisplayName: Locale, FieldType: String, DefaultValue:  , Description: The locale of the calendar.
#DesignerProperty: Key: Now, DisplayName: Now, FieldType: String, DefaultValue:  , Description: Override the day & time which is considered now. This is in the format of `YYYY-MM-DD hh:mm:ss`. The calendar is styled according to now.
...
#DesignerProperty: Key: Start, DisplayName: Start, FieldType: String, DefaultValue: 2020-10-27 , Description: The starting date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
#DesignerProperty: Key: TypeOf, DisplayName: TypeOf, FieldType: String, DefaultValue: month , Description: A string which is one of `month`, `week`, `day`, `4day`, `custom-weekly`, `custom-daily`, and `category`. The custom types look at the `start` and `end` dates passed to the component as opposed to the `value`.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: A date in the format of `YYYY-MM-DD` which determines what span of time for the calendar.
#DesignerProperty: Key: Weekdays, DisplayName: Weekdays, FieldType: String, DefaultValue:  , Description: Specifies which days of the week to display. To display Monday through Friday only, a value of `1, 2, 3, 4, 5` can be used. To display a week starting on Monday a value of `1, 2, 3, 4, 5, 6, 0` can be used.
'***** STYLES *****
...
Private stEnd As String = ""
Private stEvents As String = ""
Private stKey As String = ""
Private boLight As Boolean = False
Private stLocale As String = ""
Private stNow As String = ""
Private stParentId As String = ""
Private stRef As String = ""
Private stStart As String = "2020-10-27"
Private stTypeOf As String = "month"
...
'set The ending date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
public Sub setEnd(varEnd As String)
AddAttr("end", varEnd)
stEnd = varEnd
End Sub

'get The ending date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
public Sub getEnd() As String
Return stEnd
End Sub

'set An array of event objects with a property for a start timestamp and optionally a name and end timestamp. If an end timestamp is not given, the value of start will be used. If no name is given, you must provide an implementation for the `event` slot.
public Sub setEvents(varEvents As String)
AddAttr("events", varEvents)
stEvents = varEvents
End Sub

'get An array of event objects with a property for a start timestamp and optionally a name and end timestamp. If an end timestamp is not given, the value of start will be used. If no name is given, you must provide an implementation for the `event` slot.
public Sub getEvents() As String
Return stEvents
End Sub
...
'get The locale of the calendar.
public Sub getLocale() As String
Return stLocale
End Sub

'set Override the day & time which is considered now. This is in the format of `YYYY-MM-DD hh:mm:ss`. The calendar is styled according to now.
public Sub setNow(varNow As String)
AddAttr("now", varNow)
stNow = varNow
End Sub

'get Override the day & time which is considered now. This is in the format of `YYYY-MM-DD hh:mm:ss`. The calendar is styled according to now.
...
'set The starting date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
public Sub setStart(varStart As String)
AddAttr("start", varStart)
stStart = varStart
End Sub

'get The starting date on the calendar inclusive in the format of `YYYY-MM-DD`. This may be ignored depending on the `type` of the calendar.
public Sub getStart() As String
Return stStart
End Sub

'set A string which is one of `month`, `week`, `day`, `4day`, `custom-weekly`, `custom-daily`, and `category`. The custom types look at the `start` and `end` dates passed to the component as opposed to the `value`.
public Sub setTypeOf(varTypeOf As String)
AddAttr("type", varTypeOf)
stTypeOf = varTypeOf
End Sub

'get A string which is one of `month`, `week`, `day`, `4day`, `custom-weekly`, `custom-daily`, and `category`. The custom types look at the `start` and `end` dates passed to the component as opposed to the `value`.
...
'set A date in the format of `YYYY-MM-DD` which determines what span of time for the calendar.
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get A date in the format of `YYYY-MM-DD` which determines what span of time for the calendar.
public Sub getValue() As String
Return stValue
End Sub

'set Specifies which days of the week to display. To display Monday through Friday only, a value of `1, 2, 3, 4, 5` can be used. To display a week starting on Monday a value of `1, 2, 3, 4, 5, 6, 0` can be used.
public Sub setWeekdays(varWeekdays As String)
AddAttr("weekdays", varWeekdays)
stWeekdays = varWeekdays
End Sub

'get Specifies which days of the week to display. To display Monday through Friday only, a value of `1, 2, 3, 4, 5` can be used. To display a week starting on Monday a value of `1, 2, 3, 4, 5, 6, 0` can be used.
