...
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Removes the cards elevation.
...
#DesignerProperty: Key: Hover, DisplayName: Hover, FieldType: Boolean, DefaultValue: False , Description: Will apply an elevation of 4dp when hovered default 2dp. You can find more information on the elevation page/styles/elevation.
...
#DesignerProperty: Key: Img, DisplayName: Img, FieldType: String, DefaultValue:  , Description: Specifies an image background for the card. For more advanced implementations, it is recommended that you use the v-img/components/images component. You can find a v-img example here/components/cards/#media-with-text.
...
#DesignerProperty: Key: Raised, DisplayName: Raised, FieldType: Boolean, DefaultValue: False , Description: Specifies a higher default elevation 8dp. You can find more information on the elevation page/styles/elevation.
...
Private boRaised As Boolean = False
...
'set Removes the cards elevation.
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Removes the cards elevation.
...
'set Will apply an elevation of 4dp when hovered default 2dp. You can find more information on the elevation page/styles/elevation.
public Sub setHover(varHover As Boolean)
AddAttr("hover", varHover)
boHover = varHover
End Sub

'get Will apply an elevation of 4dp when hovered default 2dp. You can find more information on the elevation page/styles/elevation.
...
'set Specifies an image background for the card. For more advanced implementations, it is recommended that you use the v-img/components/images component. You can find a v-img example here/components/cards/#media-with-text.
public Sub setImg(varImg As String)
AddAttr("img", varImg)
stImg = varImg
End Sub

'get Specifies an image background for the card. For more advanced implementations, it is recommended that you use the v-img/components/images component. You can find a v-img example here/components/cards/#media-with-text.
public Sub getImg() As String
Return stImg
End Sub
...
'set Specifies a higher default elevation 8dp. You can find more information on the elevation page/styles/elevation.
public Sub setRaised(varRaised As Boolean)
AddAttr("raised", varRaised)
boRaised = varRaised
End Sub

'get Specifies a higher default elevation 8dp. You can find more information on the elevation page/styles/elevation.
public Sub getRaised() As Boolean
Return boRaised
End Sub
