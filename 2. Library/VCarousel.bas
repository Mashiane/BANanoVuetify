...
#DesignerProperty: Key: Continuous, DisplayName: Continuous, FieldType: Boolean, DefaultValue: True , Description: Determines whether carousel is continuous
#DesignerProperty: Key: Cycle, DisplayName: Cycle, FieldType: Boolean, DefaultValue: False , Description: Determines if the carousel should cycle through images.
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 500 , Description: Sets the height for the component
#DesignerProperty: Key: Interval, DisplayName: Interval, FieldType: String, DefaultValue: 6000 , Description: The duration between image cycles. Requires the **cycle** prop.
...
#DesignerProperty: Key: Mandatory, DisplayName: Mandatory, FieldType: Boolean, DefaultValue: True , Description: Forces a value to always be selected if available.
#DesignerProperty: Key: Max, DisplayName: Max, FieldType: String, DefaultValue:  , Description: Sets a maximum number of selections that can be made.
#DesignerProperty: Key: Multiple, DisplayName: Multiple, FieldType: Boolean, DefaultValue: False , Description: Allow multiple selections. The **value** prop must be an _array_.
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Progress, DisplayName: Progress, FieldType: Boolean, DefaultValue: False , Description: Displays a carousel progress bar. Requires the **cycle** prop and **interval**.
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Reverse, DisplayName: Reverse, FieldType: Boolean, DefaultValue: False , Description: Reverse the normal transition direction.
#DesignerProperty: Key: Touch, DisplayName: Touch, FieldType: String, DefaultValue:  , Description: Provide a custom **left** and **right** function when swiped left or right.
#DesignerProperty: Key: Touchless, DisplayName: Touchless, FieldType: Boolean, DefaultValue: False , Description: Disable touch support.
...
#DesignerProperty: Key: Vertical, DisplayName: Vertical, FieldType: Boolean, DefaultValue: False , Description: Uses a vertical transition when changing windows.
'***** STYLES *****
...
boContinuous = Props.Get("Continuous")
boCycle = Props.Get("Cycle")
boDark = Props.Get("Dark")
stHeight = Props.Get("Height")
stInterval = Props.Get("Interval")
stKey = Props.Get("Key")
boLight = Props.Get("Light")
boMandatory = Props.Get("Mandatory")
stMax = Props.Get("Max")
boMultiple = Props.Get("Multiple")
stParentId = Props.Get("ParentId")
boProgress = Props.Get("Progress")
stRef = Props.Get("Ref")
boReverse = Props.Get("Reverse")
stTouch = Props.Get("Touch")
...
AddAttr("continuous", boContinuous)
AddAttr("cycle", boCycle)
AddAttr("dark", boDark)
AddAttr("height", stHeight)
AddAttr("interval", stInterval)
AddAttr("key", stKey)
AddAttr("light", boLight)
AddAttr("mandatory", boMandatory)
AddAttr("max", stMax)
AddAttr("multiple", boMultiple)
AddAttr("parent-id", stParentId)
AddAttr("progress", boProgress)
AddAttr("ref", stRef)
AddAttr("reverse", boReverse)
AddAttr("touch", stTouch)
...
'set Determines whether carousel is continuous
public Sub setContinuous(varContinuous As Boolean)
AddAttr("continuous", varContinuous)
boContinuous = varContinuous
End Sub

'get Determines whether carousel is continuous
public Sub getContinuous() As Boolean
Return boContinuous
End Sub

'set Determines if the carousel should cycle through images.
public Sub setCycle(varCycle As Boolean)
AddAttr("cycle", varCycle)
boCycle = varCycle
End Sub

'get Determines if the carousel should cycle through images.
public Sub getCycle() As Boolean
Return boCycle
End Sub
...
'set The duration between image cycles. Requires the **cycle** prop.
public Sub setInterval(varInterval As String)
AddAttr("interval", varInterval)
stInterval = varInterval
End Sub

'get The duration between image cycles. Requires the **cycle** prop.
public Sub getInterval() As String
Return stInterval
End Sub
...
'set Forces a value to always be selected if available.
public Sub setMandatory(varMandatory As Boolean)
AddAttr("mandatory", varMandatory)
boMandatory = varMandatory
End Sub

'get Forces a value to always be selected if available.
public Sub getMandatory() As Boolean
Return boMandatory
End Sub

'set Sets a maximum number of selections that can be made.
public Sub setMax(varMax As String)
AddAttr("max", varMax)
stMax = varMax
End Sub

'get Sets a maximum number of selections that can be made.
public Sub getMax() As String
Return stMax
End Sub

'set Allow multiple selections. The **value** prop must be an _array_.
public Sub setMultiple(varMultiple As Boolean)
AddAttr("multiple", varMultiple)
boMultiple = varMultiple
End Sub

'get Allow multiple selections. The **value** prop must be an _array_.
...
'set Displays a carousel progress bar. Requires the **cycle** prop and **interval**.
public Sub setProgress(varProgress As Boolean)
AddAttr("progress", varProgress)
boProgress = varProgress
End Sub

'get Displays a carousel progress bar. Requires the **cycle** prop and **interval**.
public Sub getProgress() As Boolean
Return boProgress
End Sub
...
'set Reverse the normal transition direction.
public Sub setReverse(varReverse As Boolean)
AddAttr("reverse", varReverse)
boReverse = varReverse
End Sub

'get Reverse the normal transition direction.
public Sub getReverse() As Boolean
Return boReverse
End Sub

'set Provide a custom **left** and **right** function when swiped left or right.
public Sub setTouch(varTouch As String)
AddAttr("touch", varTouch)
stTouch = varTouch
End Sub

'get Provide a custom **left** and **right** function when swiped left or right.
public Sub getTouch() As String
Return stTouch
End Sub

'set Disable touch support.
public Sub setTouchless(varTouchless As Boolean)
AddAttr("touchless", varTouchless)
boTouchless = varTouchless
End Sub

'get Disable touch support.
...
'set Uses a vertical transition when changing windows.
public Sub setVertical(varVertical As Boolean)
AddAttr("vertical", varVertical)
boVertical = varVertical
End Sub

'get Uses a vertical transition when changing windows.
