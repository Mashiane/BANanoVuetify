...
#DesignerProperty: Key: Indeterminate, DisplayName: Indeterminate, FieldType: Boolean, DefaultValue: False , Description: Sets an indeterminate state for the checkbox
...
'set Sets an indeterminate state for the checkbox
...
'get Sets an indeterminate state for the checkbox
