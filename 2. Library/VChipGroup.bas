...
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: False , Description: Remove horizontal pagination and wrap items as needed
...
Private boColumn As Boolean = False
...
'set Remove horizontal pagination and wrap items as needed
public Sub setColumn(varColumn As Boolean)
AddAttr("column", varColumn)
boColumn = varColumn
End Sub

'get Remove horizontal pagination and wrap items as needed
