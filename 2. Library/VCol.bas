...
#DesignerProperty: Key: Cols, DisplayName: Cols, FieldType: String, DefaultValue: false , Description: Sets the default number of columns the component extends. Available options are **1 -> 12** and **auto**.
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Lg, DisplayName: Lg, FieldType: String, DefaultValue: false , Description: Changes the number of columns on large and greater breakpoints.
#DesignerProperty: Key: Md, DisplayName: Md, FieldType: String, DefaultValue: false , Description: Changes the number of columns on medium and greater breakpoints.
#DesignerProperty: Key: Offset, DisplayName: Offset, FieldType: String, DefaultValue:  , Description: Sets the default offset for the column.
#DesignerProperty: Key: Order, DisplayName: Order, FieldType: String, DefaultValue:  , Description: Sets the default orderhttps://developer.mozilla.org/en-US/docs/Web/CSS/order for the column.
...
#DesignerProperty: Key: Sm, DisplayName: Sm, FieldType: String, DefaultValue: false , Description: Changes the number of columns on small and greater breakpoints.
...
#DesignerProperty: Key: Xl, DisplayName: Xl, FieldType: String, DefaultValue: false , Description: Changes the number of columns on extra large and greater breakpoints.
'***** STYLES *****
...
Private stCols As String = "false"
Private stKey As String = ""
Private stLg As String = "false"
Private stMd As String = "false"
Private stOffset As String = ""
Private stOrder As String = ""
Private stParentId As String = ""
Private stRef As String = ""
Private stSm As String = "false"
...
stCols = Props.Get("Cols")
stKey = Props.Get("Key")
stLg = Props.Get("Lg")
stMd = Props.Get("Md")
stOffset = Props.Get("Offset")
stOrder = Props.Get("Order")
...
AddAttr("lg", stLg)
AddAttr("md", stMd)
AddAttr("offset", stOffset)
AddAttr("order", stOrder)
...
'set Sets the default number of columns the component extends. Available options are **1 -> 12** and **auto**.
public Sub setCols(varCols As String)
AddAttr("cols", varCols)
stCols = varCols
End Sub

'get Sets the default number of columns the component extends. Available options are **1 -> 12** and **auto**.
public Sub getCols() As String
Return stCols
End Sub
...
'set Changes the number of columns on large and greater breakpoints.
public Sub setLg(varLg As String)
AddAttr("lg", varLg)
stLg = varLg
End Sub

'get Changes the number of columns on large and greater breakpoints.
public Sub getLg() As String
Return stLg
End Sub

'set Changes the number of columns on medium and greater breakpoints.
public Sub setMd(varMd As String)
AddAttr("md", varMd)
stMd = varMd
End Sub

'get Changes the number of columns on medium and greater breakpoints.
public Sub getMd() As String
Return stMd
End Sub

'set Sets the default offset for the column.
public Sub setOffset(varOffset As String)
AddAttr("offset", varOffset)
stOffset = varOffset
End Sub

'get Sets the default offset for the column.
public Sub getOffset() As String
Return stOffset
End Sub

'set Sets the default orderhttps://developer.mozilla.org/en-US/docs/Web/CSS/order for the column.
public Sub setOrder(varOrder As String)
AddAttr("order", varOrder)
stOrder = varOrder
End Sub

'get Sets the default orderhttps://developer.mozilla.org/en-US/docs/Web/CSS/order for the column.
...
'set Changes the number of columns on small and greater breakpoints.
public Sub setSm(varSm As String)
AddAttr("sm", varSm)
stSm = varSm
End Sub

'get Changes the number of columns on small and greater breakpoints.
public Sub getSm() As String
Return stSm
End Sub
...
'set Changes the number of columns on extra large and greater breakpoints.
public Sub setXl(varXl As String)
AddAttr("xl", varXl)
stXl = varXl
End Sub

'get Changes the number of columns on extra large and greater breakpoints.
public Sub getXl() As String
Return stXl
End Sub
