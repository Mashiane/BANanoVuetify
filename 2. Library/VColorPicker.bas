...
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue: rgba , Description: Sets mode of inputs. Available modes are rgba, hsla, and hexa. Can be synced with the `.sync` modifier.
...
#DesignerProperty: Key: Swatches, DisplayName: Swatches, FieldType: String, DefaultValue:  , Description: Sets the available color swatches to select from - This prop only accepts rgba hex strings
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Current color. This can be either a string representing a hex color, or an object representing a RGBA, HSLA, or HSVA value
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 300 , Description: Sets the width of the color picker
'***** STYLES *****
...
Private stMode As String = "rgba"
Private stParentId As String = ""
Private stRef As String = ""
Private stSwatches As String = ""
...
'set Sets mode of inputs. Available modes are rgba, hsla, and hexa. Can be synced with the `.sync` modifier.
public Sub setMode(varMode As String)
AddAttr("mode", varMode)
stMode = varMode
End Sub

'get Sets mode of inputs. Available modes are rgba, hsla, and hexa. Can be synced with the `.sync` modifier.
...
'set Sets the available color swatches to select from - This prop only accepts rgba hex strings
public Sub setSwatches(varSwatches As String)
AddAttr("swatches", varSwatches)
stSwatches = varSwatches
End Sub

'get Sets the available color swatches to select from - This prop only accepts rgba hex strings
public Sub getSwatches() As String
Return stSwatches
End Sub
...
'set Current color. This can be either a string representing a hex color, or an object representing a RGBA, HSLA, or HSVA value
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Current color. This can be either a string representing a hex color, or an object representing a RGBA, HSLA, or HSVA value
public Sub getValue() As String
Return stValue
End Sub

'set Sets the width of the color picker
public Sub setWidth(varWidth As String)
AddAttr("width", varWidth)
stWidth = varWidth
End Sub

'get Sets the width of the color picker
