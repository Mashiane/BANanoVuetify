...
#DesignerProperty: Key: Fluid, DisplayName: Fluid, FieldType: Boolean, DefaultValue: False , Description: Removes viewport maximum-width size breakpoints
...
Private boFluid As Boolean = False
...
'set Removes viewport maximum-width size breakpoints
public Sub setFluid(varFluid As Boolean)
AddAttr("fluid", varFluid)
boFluid = varFluid
End Sub

'get Removes viewport maximum-width size breakpoints
public Sub getFluid() As Boolean
Return boFluid
End Sub
