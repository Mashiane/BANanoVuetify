...
#DesignerProperty: Key: Options, DisplayName: Options, FieldType: String, DefaultValue:  , Description: DataOptions
#DesignerProperty: Key: Pagination, DisplayName: Pagination, FieldType: String, DefaultValue:  , Description: DataPagination
...
Private stPagination As String = ""
...
stPagination = Props.Get("Pagination")
...
AddAttr("pagination", stPagination)
...
'set DataPagination
public Sub setPagination(varPagination As String)
AddAttr("pagination", varPagination)
stPagination = varPagination
End Sub

'get DataPagination
public Sub getPagination() As String
Return stPagination
End Sub
...
If BANano.IsUndefined(eOnUpdateOptions) Or BANano.IsNull(eOnUpdateOptions) Then eOnUpdateOptions = ""
Dim sCode As String = $"${sName}(${eOnUpdateOptions})"$
AddAttr("v-on:update:options", sCode)
...
Sub SetOnUpdateOptionsE(sUpdateOptions As String)
