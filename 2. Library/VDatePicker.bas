...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables interaction with the picker
...
#DesignerProperty: Key: Events, DisplayName: Events, FieldType: String, DefaultValue:  , Description: Array of dates or object defining events or colors or function returning boolean/color/array of colors
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Removes  elevation
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Landscape, DisplayName: Landscape, FieldType: Boolean, DefaultValue: False , Description: Orients picker horizontal
...
#DesignerProperty: Key: Locale, DisplayName: Locale, FieldType: String, DefaultValue:  , Description: Sets the locale. Accepts a string with a BCP 47 language tag.
#DesignerProperty: Key: Max, DisplayName: Max, FieldType: String, DefaultValue:  , Description: Maximum allowed date/month ISO 8601 format
#DesignerProperty: Key: Min, DisplayName: Min, FieldType: String, DefaultValue:  , Description: Minimum allowed date/month ISO 8601 format
#DesignerProperty: Key: Multiple, DisplayName: Multiple, FieldType: Boolean, DefaultValue: False , Description: Allow the selection of multiple dates
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Range, DisplayName: Range, FieldType: Boolean, DefaultValue: False , Description: Allow the selection of date range
#DesignerProperty: Key: Reactive, DisplayName: Reactive, FieldType: Boolean, DefaultValue: False , Description: Updates the picker model when changing months/years automatically
#DesignerProperty: Key: Readonly, DisplayName: Readonly, FieldType: Boolean, DefaultValue: False , Description: Makes the picker readonly doesnt allow to select new date
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Scrollable, DisplayName: Scrollable, FieldType: Boolean, DefaultValue: False , Description: Allows changing displayed month with mouse scroll
#DesignerProperty: Key: TypeOf, DisplayName: TypeOf, FieldType: String, DefaultValue: date , Description: Determines the type of the picker - `date` for date picker, `month` for month picker
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Date picker model ISO 8601 format, YYYY-mm-dd or YYYY-mm
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 290 , Description: Width of the picker
'***** STYLES *****
...
Private boLandscape As Boolean = False
Private boLight As Boolean = False
Private stLocale As String = ""
Private stMax As String = ""
Private stMin As String = ""
Private boMultiple As Boolean = False
Private stParentId As String = ""
Private boRange As Boolean = False
Private boReactive As Boolean = False
Private boReadonly As Boolean = False
Private stRef As String = ""
Private boScrollable As Boolean = False
Private stTypeOf As String = "date"
...
stKey = Props.Get("Key")
boLandscape = Props.Get("Landscape")
...
boRange = Props.Get("Range")
boReactive = Props.Get("Reactive")
boReadonly = Props.Get("Readonly")
stRef = Props.Get("Ref")
boScrollable = Props.Get("Scrollable")
...
AddAttr("range", boRange)
AddAttr("reactive", boReactive)
AddAttr("readonly", boReadonly)
AddAttr("ref", stRef)
AddAttr("scrollable", boScrollable)
...
'set Array of dates or object defining events or colors or function returning boolean/color/array of colors
public Sub setEvents(varEvents As String)
AddAttr("events", varEvents)
stEvents = varEvents
End Sub

'get Array of dates or object defining events or colors or function returning boolean/color/array of colors
public Sub getEvents() As String
Return stEvents
End Sub

'set Removes  elevation
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Removes  elevation
...
'set Orients picker horizontal
public Sub setLandscape(varLandscape As Boolean)
AddAttr("landscape", varLandscape)
boLandscape = varLandscape
End Sub

'get Orients picker horizontal
...
'set Sets the locale. Accepts a string with a BCP 47 language tag.
public Sub setLocale(varLocale As String)
AddAttr("locale", varLocale)
stLocale = varLocale
End Sub

'get Sets the locale. Accepts a string with a BCP 47 language tag.
public Sub getLocale() As String
Return stLocale
End Sub

'set Maximum allowed date/month ISO 8601 format
public Sub setMax(varMax As String)
AddAttr("max", varMax)
stMax = varMax
End Sub

'get Maximum allowed date/month ISO 8601 format
public Sub getMax() As String
Return stMax
End Sub

'set Minimum allowed date/month ISO 8601 format
public Sub setMin(varMin As String)
AddAttr("min", varMin)
stMin = varMin
End Sub

'get Minimum allowed date/month ISO 8601 format
public Sub getMin() As String
Return stMin
End Sub

'set Allow the selection of multiple dates
public Sub setMultiple(varMultiple As Boolean)
AddAttr("multiple", varMultiple)
boMultiple = varMultiple
End Sub

'get Allow the selection of multiple dates
...
'set Allow the selection of date range
public Sub setRange(varRange As Boolean)
AddAttr("range", varRange)
boRange = varRange
End Sub

'get Allow the selection of date range
public Sub getRange() As Boolean
Return boRange
End Sub

'set Updates the picker model when changing months/years automatically
public Sub setReactive(varReactive As Boolean)
AddAttr("reactive", varReactive)
boReactive = varReactive
End Sub

'get Updates the picker model when changing months/years automatically
public Sub getReactive() As Boolean
Return boReactive
End Sub

'set Makes the picker readonly doesnt allow to select new date
public Sub setReadonly(varReadonly As Boolean)
AddAttr("readonly", varReadonly)
boReadonly = varReadonly
End Sub

'get Makes the picker readonly doesnt allow to select new date
...
'set Allows changing displayed month with mouse scroll
public Sub setScrollable(varScrollable As Boolean)
AddAttr("scrollable", varScrollable)
boScrollable = varScrollable
End Sub

'get Allows changing displayed month with mouse scroll
public Sub getScrollable() As Boolean
Return boScrollable
End Sub

'set Determines the type of the picker - `date` for date picker, `month` for month picker
public Sub setTypeOf(varTypeOf As String)
AddAttr("type", varTypeOf)
stTypeOf = varTypeOf
End Sub

'get Determines the type of the picker - `date` for date picker, `month` for month picker
...
'set Date picker model ISO 8601 format, YYYY-mm-dd or YYYY-mm
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Date picker model ISO 8601 format, YYYY-mm-dd or YYYY-mm
public Sub getValue() As String
Return stValue
End Sub

'set Width of the picker
public Sub setWidth(varWidth As String)
AddAttr("width", varWidth)
stWidth = varWidth
End Sub

'get Width of the picker
...
Sub SetOnDomeventDate()
Dim sName As String = $"${mEventName}_DomeventDate"$
sName = sName.tolowercase
If SubExists(mCallBack, sName) = False Then Return
If BANano.IsUndefined(eOnDomeventDate) Or BANano.IsNull(eOnDomeventDate) Then eOnDomeventDate = ""
Dim sCode As String = $"${sName}(${eOnDomeventDate})"$
AddAttr("v-on:<domevent>:date", sCode)
...
Sub SetOnDomeventDateE(sDomeventDate As String)
