...
@EndOfDesignText@
#IgnoreWarnings:12
'Created with BANano Custom View Creator 1.7 by TheMash
...
#DesignerProperty: Key: TagName, DisplayName: TagName, FieldType: String, DefaultValue: main , Description: Specify a custom tag used on the root element.
...
public Sub setTagName(varTag As String)
	mTagName = varTag
End Sub
