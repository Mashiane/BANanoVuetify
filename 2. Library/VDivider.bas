...
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: Adds indentation 72px for **normal** dividers, reduces max height for **vertical**.
...
#DesignerProperty: Key: Vertical, DisplayName: Vertical, FieldType: Boolean, DefaultValue: False , Description: Displays dividers vertically
'***** STYLES *****
...
'set Adds indentation 72px for **normal** dividers, reduces max height for **vertical**.
public Sub setInset(varInset As Boolean)
AddAttr("inset", varInset)
boInset = varInset
End Sub

'get Adds indentation 72px for **normal** dividers, reduces max height for **vertical**.
