...
#DesignerProperty: Key: Large, DisplayName: Large, FieldType: Boolean, DefaultValue: False , Description: Attaches a submit and cancel button to the dialog
...
#DesignerProperty: Key: Persistent, DisplayName: Persistent, FieldType: Boolean, DefaultValue: False , Description: Clicking outside will not dismiss the dialog
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: slide-x-reverse-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
Private stTransition As String = "slide-x-reverse-transition"
...
'set Attaches a submit and cancel button to the dialog
public Sub setLarge(varLarge As Boolean)
AddAttr("large", varLarge)
boLarge = varLarge
End Sub

'get Attaches a submit and cancel button to the dialog
...
If BANano.IsUndefined(eOnCancel) Or BANano.IsNull(eOnCancel) Then eOnCancel = ""
Dim sCode As String = $"${sName}(${eOnCancel})"$
AddAttr("v-on:cancel", sCode)
...
Sub SetOnCancelE(sCancel As String)
eOnCancel = sCancel
End Sub
