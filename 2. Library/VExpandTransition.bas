...
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue: in-out , Description: Sets the transition mode does not apply to transition-group. You can find more information on the Vue documentation for transition modeshttps://vuejs.org/v2/api/#transition.
...
Private stMode As String = "in-out"
