...
#DesignerProperty: Key: Accordion, DisplayName: Accordion, FieldType: Boolean, DefaultValue: False , Description: Removes the margin around open panels
...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables the entire expansion-panel
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Removes the expansion-panels elevation and borders
#DesignerProperty: Key: Focusable, DisplayName: Focusable, FieldType: Boolean, DefaultValue: False , Description: Makes the expansion-panel headers focusable
#DesignerProperty: Key: Hover, DisplayName: Hover, FieldType: Boolean, DefaultValue: False , Description: Applies a background-color shift on hover to expansion panel headers
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: Makes the expansion-panel open with a inset style
...
#DesignerProperty: Key: Mandatory, DisplayName: Mandatory, FieldType: Boolean, DefaultValue: False , Description: Forces a value to always be selected if available.
...
#DesignerProperty: Key: Popout, DisplayName: Popout, FieldType: Boolean, DefaultValue: False , Description: Makes the expansion-panel open with an popout style
#DesignerProperty: Key: Readonly, DisplayName: Readonly, FieldType: Boolean, DefaultValue: False , Description: Makes the entire expansion-panel read only.
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Tile, DisplayName: Tile, FieldType: Boolean, DefaultValue: False , Description: Removes the border-radius
...
boAccordion = Props.Get("Accordion")
boDark = Props.Get("Dark")
boDisabled = Props.Get("Disabled")
boFlat = Props.Get("Flat")
boFocusable = Props.Get("Focusable")
boHover = Props.Get("Hover")
...
AddAttr("accordion", boAccordion)
AddAttr("dark", boDark)
AddAttr("disabled", boDisabled)
AddAttr("flat", boFlat)
AddAttr("focusable", boFocusable)
AddAttr("hover", boHover)
...
'set Removes the margin around open panels
public Sub setAccordion(varAccordion As Boolean)
AddAttr("accordion", varAccordion)
boAccordion = varAccordion
End Sub

'get Removes the margin around open panels
public Sub getAccordion() As Boolean
Return boAccordion
End Sub
...
'set Disables the entire expansion-panel
public Sub setDisabled(varDisabled As Boolean)
AddAttr("disabled", varDisabled)
boDisabled = varDisabled
End Sub

'get Disables the entire expansion-panel
public Sub getDisabled() As Boolean
Return boDisabled
End Sub

'set Removes the expansion-panels elevation and borders
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Removes the expansion-panels elevation and borders
public Sub getFlat() As Boolean
Return boFlat
End Sub

'set Makes the expansion-panel headers focusable
public Sub setFocusable(varFocusable As Boolean)
AddAttr("focusable", varFocusable)
boFocusable = varFocusable
End Sub

'get Makes the expansion-panel headers focusable
public Sub getFocusable() As Boolean
Return boFocusable
End Sub

'set Applies a background-color shift on hover to expansion panel headers
public Sub setHover(varHover As Boolean)
AddAttr("hover", varHover)
boHover = varHover
End Sub

'get Applies a background-color shift on hover to expansion panel headers
public Sub getHover() As Boolean
Return boHover
End Sub

'set Makes the expansion-panel open with a inset style
public Sub setInset(varInset As Boolean)
AddAttr("inset", varInset)
boInset = varInset
End Sub

'get Makes the expansion-panel open with a inset style
...
'set Makes the expansion-panel open with an popout style
public Sub setPopout(varPopout As Boolean)
AddAttr("popout", varPopout)
boPopout = varPopout
End Sub

'get Makes the expansion-panel open with an popout style
public Sub getPopout() As Boolean
Return boPopout
End Sub

'set Makes the entire expansion-panel read only.
public Sub setReadonly(varReadonly As Boolean)
AddAttr("readonly", varReadonly)
boReadonly = varReadonly
End Sub

'get Makes the entire expansion-panel read only.
...
'set Removes the border-radius
public Sub setTile(varTile As Boolean)
AddAttr("tile", varTile)
boTile = varTile
End Sub

'get Removes the border-radius
