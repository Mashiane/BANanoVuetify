...
#DesignerProperty: Key: Group, DisplayName: Group, FieldType: Boolean, DefaultValue: False , Description: Creates a `transition-group` component. vue docshttps://vuejs.org/v2/api/#transition-group
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue: out-in , Description: Sets the transition mode does not apply to transition-group. You can find more information on the Vue documentation for transition modeshttps://vuejs.org/v2/api/#transition.
...
Private stMode As String = "out-in"
...
'set Creates a `transition-group` component. vue docshttps://vuejs.org/v2/api/#transition-group
public Sub setGroup(varGroup As Boolean)
AddAttr("group", varGroup)
boGroup = varGroup
End Sub

'get Creates a `transition-group` component. vue docshttps://vuejs.org/v2/api/#transition-group
