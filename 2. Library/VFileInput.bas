...
#DesignerProperty: Key: Clearable, DisplayName: Clearable, FieldType: Boolean, DefaultValue: True , Description: Add input clear functionality, default icon is Material Design Icons **mdi-clear**
...
#DesignerProperty: Key: Multiple, DisplayName: Multiple, FieldType: Boolean, DefaultValue: False , Description: Adds the **multiple** attribute to the input, allowing multiple file selections.
...
#DesignerProperty: Key: TypeOf, DisplayName: TypeOf, FieldType: String, DefaultValue: file , Description: Sets input type
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: A single or array of File objectshttps://developer.mozilla.org/en-US/docs/Web/API/File.
'***** STYLES *****
...
Private boClearable As Boolean = True
...
Private stTypeOf As String = "file"
...
'set Adds the **multiple** attribute to the input, allowing multiple file selections.
public Sub setMultiple(varMultiple As Boolean)
AddAttr("multiple", varMultiple)
boMultiple = varMultiple
End Sub

'get Adds the **multiple** attribute to the input, allowing multiple file selections.
...
'set A single or array of File objectshttps://developer.mozilla.org/en-US/docs/Web/API/File.
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get A single or array of File objectshttps://developer.mozilla.org/en-US/docs/Web/API/File.
