...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: auto , Description: Sets the height for the component.
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: Positions the toolbar offset from an application `v-navigation-drawer`
...
#DesignerProperty: Key: Padless, DisplayName: Padless, FieldType: Boolean, DefaultValue: False , Description: Remove all padding from the footer
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: footer , Description: Specify a custom tag used on the root element.
...
Private stHeight As String = "auto"
...
'set Positions the toolbar offset from an application `v-navigation-drawer`
public Sub setInset(varInset As Boolean)
AddAttr("inset", varInset)
boInset = varInset
End Sub

'get Positions the toolbar offset from an application `v-navigation-drawer`
...
'set Remove all padding from the footer
public Sub setPadless(varPadless As Boolean)
AddAttr("padless", varPadless)
boPadless = varPadless
End Sub

'get Remove all padding from the footer
public Sub getPadless() As Boolean
Return boPadless
End Sub
