...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Puts all children inputs into a disabled state.
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Readonly, DisplayName: Readonly, FieldType: Boolean, DefaultValue: False , Description: Puts all children inputs into a readonly state.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: False , Description: A boolean value representing the validity of the form.
'***** STYLES *****
...
'set Puts all children inputs into a disabled state.
public Sub setDisabled(varDisabled As Boolean)
AddAttr("disabled", varDisabled)
boDisabled = varDisabled
End Sub

'get Puts all children inputs into a disabled state.
...
'set Puts all children inputs into a readonly state.
public Sub setReadonly(varReadonly As Boolean)
AddAttr("readonly", varReadonly)
boReadonly = varReadonly
End Sub

'get Puts all children inputs into a readonly state.
...
'set A boolean value representing the validity of the form.
public Sub setValue(varValue As Boolean)
AddAttr("value", varValue)
boValue = varValue
End Sub

'get A boolean value representing the validity of the form.
