...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Turns off hover functionality
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: False , Description: Controls whether the component is visible or hidden.
'***** STYLES *****
