...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Makes icon smaller 20px
...
#DesignerProperty: Key: Left, DisplayName: Left, FieldType: Boolean, DefaultValue: False , Description: Applies appropriate margins to the icon when placed to the **left** of another element or text. Typically used inside of a button
...
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: Applies appropriate margins to the icon when placed to the **right** of another element or text. Typically used inside of a button
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, DefaultValue:  , Description: Specifies a custom font size for the icon
#DesignerProperty: Key: Small, DisplayName: Small, FieldType: Boolean, DefaultValue: False , Description: Makes the component small.
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: i , Description: Specifies a custom tag to be used
...
'set Applies appropriate margins to the icon when placed to the **left** of another element or text. Typically used inside of a button
public Sub setLeft(varLeft As Boolean)
AddAttr("left", varLeft)
boLeft = varLeft
End Sub

'get Applies appropriate margins to the icon when placed to the **left** of another element or text. Typically used inside of a button
...
'set Applies appropriate margins to the icon when placed to the **right** of another element or text. Typically used inside of a button
public Sub setRight(varRight As Boolean)
AddAttr("right", varRight)
boRight = varRight
End Sub

'get Applies appropriate margins to the icon when placed to the **right** of another element or text. Typically used inside of a button
public Sub getRight() As Boolean
Return boRight
End Sub

'set Specifies a custom font size for the icon
public Sub setSize(varSize As String)
AddAttr("size", varSize)
stSize = varSize
End Sub

'get Specifies a custom font size for the icon
...
'set Specifies a custom tag to be used
public Sub setTag(varTag As String)
AddAttr("tag", varTag)
stTag = varTag
End Sub

'get Specifies a custom tag to be used
