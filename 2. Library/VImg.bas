...
#DesignerProperty: Key: Alt, DisplayName: Alt, FieldType: String, DefaultValue:  , Description: Alternate text for screen readers. Leave empty for decorative images
#DesignerProperty: Key: Contain, DisplayName: Contain, FieldType: Boolean, DefaultValue: False , Description: Prevents the image from being cropped if it doesnt fit
...
#DesignerProperty: Key: Gradient, DisplayName: Gradient, FieldType: String, DefaultValue:  , Description: Overlays a gradient onto the image. Only supports linear-gradienthttps://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient syntax, anything else should be done with classes see examples
...
#DesignerProperty: Key: Options, DisplayName: Options, FieldType: String, DefaultValue:  , Description: Options that are passed to the Intersection observerhttps://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API constructor.
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Position, DisplayName: Position, FieldType: String, DefaultValue: center center , Description: Overrides the default to change which parts get cropped off. Uses the same syntax as `background-position`https://developer.mozilla.org/en-US/docs/Web/CSS/background-position
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Sizes, DisplayName: Sizes, FieldType: String, DefaultValue:  , Description: For use with `srcset`, see MDNhttps://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-sizes
#DesignerProperty: Key: Src, DisplayName: Src, FieldType: String, DefaultValue:  , Description: The image URL. This prop is mandatory
#DesignerProperty: Key: Srcset, DisplayName: Srcset, FieldType: String, DefaultValue:  , Description: A set of alternate images to use based on device size. Read more...https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: fade-transition , Description: The transition to use when switching from `lazy-src` to `src`
...
AddAttr("alt", stAlt)
AddAttr("contain", boContain)
AddAttr("dark", boDark)
AddAttr("eager", boEager)
AddAttr("gradient", stGradient)
AddAttr("height", stHeight)
AddAttr("key", stKey)
AddAttr("light", boLight)
AddAttr("options", stOptions)
AddAttr("parent-id", stParentId)
AddAttr("position", stPosition)
AddAttr("ref", stRef)
AddAttr("sizes", stSizes)
AddAttr("src", stSrc)
...
'set Alternate text for screen readers. Leave empty for decorative images
public Sub setAlt(varAlt As String)
AddAttr("alt", varAlt)
stAlt = varAlt
End Sub

'get Alternate text for screen readers. Leave empty for decorative images
public Sub getAlt() As String
Return stAlt
End Sub

'set Prevents the image from being cropped if it doesnt fit
public Sub setContain(varContain As Boolean)
AddAttr("contain", varContain)
boContain = varContain
End Sub

'get Prevents the image from being cropped if it doesnt fit
public Sub getContain() As Boolean
Return boContain
End Sub
...
'set Overlays a gradient onto the image. Only supports linear-gradienthttps://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient syntax, anything else should be done with classes see examples
public Sub setGradient(varGradient As String)
AddAttr("gradient", varGradient)
stGradient = varGradient
End Sub

'get Overlays a gradient onto the image. Only supports linear-gradienthttps://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient syntax, anything else should be done with classes see examples
public Sub getGradient() As String
Return stGradient
End Sub
...
'set Options that are passed to the Intersection observerhttps://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API constructor.
public Sub setOptions(varOptions As String)
AddAttr("options", varOptions)
stOptions = varOptions
End Sub

'get Options that are passed to the Intersection observerhttps://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API constructor.
public Sub getOptions() As String
Return stOptions
End Sub
...
'set Overrides the default to change which parts get cropped off. Uses the same syntax as `background-position`https://developer.mozilla.org/en-US/docs/Web/CSS/background-position
public Sub setPosition(varPosition As String)
AddAttr("position", varPosition)
stPosition = varPosition
End Sub

'get Overrides the default to change which parts get cropped off. Uses the same syntax as `background-position`https://developer.mozilla.org/en-US/docs/Web/CSS/background-position
...
'set For use with `srcset`, see MDNhttps://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-sizes
public Sub setSizes(varSizes As String)
AddAttr("sizes", varSizes)
stSizes = varSizes
End Sub

'get For use with `srcset`, see MDNhttps://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-sizes
public Sub getSizes() As String
Return stSizes
End Sub

'set The image URL. This prop is mandatory
public Sub setSrc(varSrc As String)
AddAttr("src", varSrc)
stSrc = varSrc
End Sub

'get The image URL. This prop is mandatory
public Sub getSrc() As String
Return stSrc
End Sub

'set A set of alternate images to use based on device size. Read more...https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset
public Sub setSrcset(varSrcset As String)
AddAttr("srcset", varSrcset)
stSrcset = varSrcset
End Sub

'get A set of alternate images to use based on device size. Read more...https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset
public Sub getSrcset() As String
Return stSrcset
End Sub

'set The transition to use when switching from `lazy-src` to `src`
public Sub setTransition(varTransition As String)
AddAttr("transition", varTransition)
stTransition = varTransition
End Sub

'get The transition to use when switching from `lazy-src` to `src`
...
If BANano.IsUndefined(eOnError) Or BANano.IsNull(eOnError) Then eOnError = ""
Dim sCode As String = $"${sName}(${eOnError})"$
AddAttr("v-on:error", sCode)
...
Sub SetOnErrorE(sError As String)
eOnError = sError
End Sub
