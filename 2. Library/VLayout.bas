...
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Reverse, DisplayName: Reverse, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Row, DisplayName: Row, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Wrap, DisplayName: Wrap, FieldType: Boolean, DefaultValue: False , Description: 
'***** STYLES *****
...
Private boWrap As Boolean = False
...
'set wrap
public Sub setWrap(varWrap As Boolean)
AddAttr("wrap", varWrap)
boWrap = varWrap
End Sub
