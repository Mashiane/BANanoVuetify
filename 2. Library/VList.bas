...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Lowers max height of list tiles
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables all children `v-list-item` components
...
#DesignerProperty: Key: Expand, DisplayName: Expand, FieldType: Boolean, DefaultValue: False , Description: Will only collapse when explicitly closed
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Remove the highlighted background on active `v-list-item`s
...
#DesignerProperty: Key: Nav, DisplayName: Nav, FieldType: Boolean, DefaultValue: False , Description: An alternative styling that reduces `v-list-item` width and rounds the corners. Typically used with **v-navigation-drawer/components/navigation-drawers**
...
#DesignerProperty: Key: Rounded, DisplayName: Rounded, FieldType: Boolean, DefaultValue: False , Description: Rounds the `v-list-item` edges
#DesignerProperty: Key: Shaped, DisplayName: Shaped, FieldType: Boolean, DefaultValue: False , Description: Provides an alternative active style for `v-list-item`.
#DesignerProperty: Key: Subheader, DisplayName: Subheader, FieldType: Boolean, DefaultValue: False , Description: Removes top padding. Used when previous sibling is a header
...
Private boSubheader As Boolean = False
...
boSubheader = Props.Get("Subheader")
stTag = Props.Get("Tag")
...
'set Will only collapse when explicitly closed
public Sub setExpand(varExpand As Boolean)
AddAttr("expand", varExpand)
boExpand = varExpand
End Sub

'get Will only collapse when explicitly closed
public Sub getExpand() As Boolean
Return boExpand
End Sub

'set Remove the highlighted background on active `v-list-item`s
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Remove the highlighted background on active `v-list-item`s
...
'set An alternative styling that reduces `v-list-item` width and rounds the corners. Typically used with **v-navigation-drawer/components/navigation-drawers**
public Sub setNav(varNav As Boolean)
AddAttr("nav", varNav)
boNav = varNav
End Sub

'get An alternative styling that reduces `v-list-item` width and rounds the corners. Typically used with **v-navigation-drawer/components/navigation-drawers**
public Sub getNav() As Boolean
Return boNav
End Sub
...
'set Rounds the `v-list-item` edges
public Sub setRounded(varRounded As Boolean)
AddAttr("rounded", varRounded)
boRounded = varRounded
End Sub

'get Rounds the `v-list-item` edges
public Sub getRounded() As Boolean
Return boRounded
End Sub

'set Provides an alternative active style for `v-list-item`.
public Sub setShaped(varShaped As Boolean)
AddAttr("shaped", varShaped)
boShaped = varShaped
End Sub

'get Provides an alternative active style for `v-list-item`.
public Sub getShaped() As Boolean
Return boShaped
End Sub

'set Removes top padding. Used when previous sibling is a header
public Sub setSubheader(varSubheader As Boolean)
AddAttr("subheader", varSubheader)
boSubheader = varSubheader
End Sub

'get Removes top padding. Used when previous sibling is a header
public Sub getSubheader() As Boolean
Return boSubheader
End Sub
