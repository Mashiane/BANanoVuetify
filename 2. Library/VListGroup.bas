...
#DesignerProperty: Key: Group, DisplayName: Group, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: String, DefaultValue: true , Description: 
...
'set group
public Sub setGroup(varGroup As String)
AddAttr("group", varGroup)
stGroup = varGroup
End Sub

'get group
public Sub getGroup() As String
Return stGroup
End Sub
