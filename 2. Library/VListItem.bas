...
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue:  , Description: Applies specified color to the control when in an **active** state or **input-value** is **true** - it can be the name of material color for example `success` or `purple` or css color `#033` or `rgba255, 0, 0, 0.5`
...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables the component
...
#DesignerProperty: Key: Inactive, DisplayName: Inactive, FieldType: Boolean, DefaultValue: False , Description: If set, the list tile will not be rendered as a link even if it has to/href prop or @click handler
...
#DesignerProperty: Key: Selectable, DisplayName: Selectable, FieldType: Boolean, DefaultValue: False , Description: Allow text selection inside `v-list-item`. This prop uses user-selecthttps://developer.mozilla.org/en-US/docs/Web/CSS/user-select
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: The value used when a child of a v-list-item-group/components/list-item-groups.
'***** STYLES *****
...
Private boInactive As Boolean = False
...
'set Applies specified color to the control when in an **active** state or **input-value** is **true** - it can be the name of material color for example `success` or `purple` or css color `#033` or `rgba255, 0, 0, 0.5`
public Sub setColor(varColor As String)
AddAttr("color", varColor)
stColor = varColor
End Sub

'get Applies specified color to the control when in an **active** state or **input-value** is **true** - it can be the name of material color for example `success` or `purple` or css color `#033` or `rgba255, 0, 0, 0.5`
...
'set If set, the list tile will not be rendered as a link even if it has to/href prop or @click handler
public Sub setInactive(varInactive As Boolean)
AddAttr("inactive", varInactive)
boInactive = varInactive
End Sub

'get If set, the list tile will not be rendered as a link even if it has to/href prop or @click handler
public Sub getInactive() As Boolean
Return boInactive
End Sub
...
'set Allow text selection inside `v-list-item`. This prop uses user-selecthttps://developer.mozilla.org/en-US/docs/Web/CSS/user-select
public Sub setSelectable(varSelectable As Boolean)
AddAttr("selectable", varSelectable)
boSelectable = varSelectable
End Sub

'get Allow text selection inside `v-list-item`. This prop uses user-selecthttps://developer.mozilla.org/en-US/docs/Web/CSS/user-select
...
'set The value used when a child of a v-list-item-group/components/list-item-groups.
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get The value used when a child of a v-list-item-group/components/list-item-groups.
