...
#DesignerProperty: Key: Horizontal, DisplayName: Horizontal, FieldType: Boolean, DefaultValue: False , Description: Uses an alternative horizontal style.
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Left, DisplayName: Left, FieldType: Boolean, DefaultValue: False , Description: Designates that the avatar is on the left side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
...
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: Designates that the avatar is on the right side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
...
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, DefaultValue: 40 , Description: Sets the height and width of the component.
...
Private boHorizontal As Boolean = False
...
boHorizontal = Props.Get("Horizontal")
stKey = Props.Get("Key")
...
AddAttr("horizontal", boHorizontal)
AddAttr("key", stKey)
AddAttr("left", boLeft)
...
'set Uses an alternative horizontal style.
public Sub setHorizontal(varHorizontal As Boolean)
AddAttr("horizontal", varHorizontal)
boHorizontal = varHorizontal
End Sub

'get Uses an alternative horizontal style.
...
'set Designates that the avatar is on the left side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
public Sub setLeft(varLeft As Boolean)
AddAttr("left", varLeft)
boLeft = varLeft
End Sub

'get Designates that the avatar is on the left side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
...
'set Designates that the avatar is on the right side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
public Sub setRight(varRight As Boolean)
AddAttr("right", varRight)
boRight = varRight
End Sub

'get Designates that the avatar is on the right side of a component. This is hooked into by components such as v-chip/components/chips and v-btn/components/buttons.
