...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Expands / Collapse list group
'***** STYLES *****
...
'set Expands / Collapse list group
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Expands / Collapse list group
