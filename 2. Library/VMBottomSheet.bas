...
BottomSheet.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMBottomSheet
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMBottomSheet
	Dim sColor As String = $"${varColor}--text"$
