...
Sub SetVIf(vif As String) As VMCalendarDaily
	CalendarDaily.SetVIf(vif)
	Return Me
End Sub

Sub SetVShow(vif As String) As VMCalendarDaily
...
'set color intensity
Sub SetTextColor(varColor As String) As VMCalendarDaily
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMCalendarDaily
	Dim sColor As String = $"${varColor}--text"$
