...
Sub SetVIf(vif As String) As VMCalendarWeekly
	CalendarWeekly.SetVIf(vif)
	Return Me
End Sub

Sub SetVShow(vif As String) As VMCalendarWeekly
...
Return Me
End Sub
Sub SetVisible(b As Boolean) As VMCalendarWeekly
CalendarWeekly.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMCalendarWeekly
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMCalendarWeekly
	Dim sColor As String = $"${varColor}--text"$
