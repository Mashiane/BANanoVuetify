...
Return Me
End Sub
'Sub SetVisible(b As Boolean) As VMDevices
Devices.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMDevices
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMDevices
	Dim sColor As String = $"${varColor}--text"$
