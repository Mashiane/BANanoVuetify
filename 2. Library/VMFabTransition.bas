...
Sub SetData(xprop As String, xValue As Object) As VMFabTransition
...
Sub AddElement(elm As VMElement)
	FabTransition.SetText(elm.ToString)
End Sub

Sub AddElement1(elID As String, elTag As String, elText As String, mprops As Map, mstyles As Map, lclasses As List) As VMFabTransition
	Dim d As VMElement
