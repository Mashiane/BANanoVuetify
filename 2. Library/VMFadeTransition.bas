...
Sub AddElement(elm As VMElement)
	FadeTransition.SetText(elm.ToString)
End Sub

Sub AddElement1(elID As String, elTag As String, elText As String, mprops As Map, mstyles As Map, lclasses As List) As VMFadeTransition
	Dim d As VMElement
