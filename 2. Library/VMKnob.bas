...
Return Me
End Sub
Sub SetVisible(b As Boolean) As VMKnob
Knob.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMKnob
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMKnob
	Dim sColor As String = $"${varColor}--text"$
