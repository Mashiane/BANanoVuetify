...
Sub SetData(xprop As String, xValue As Object) As VMListItemSubTitle
...
Sub SetVIf(vif As String) As VMListItemSubTitle
	ListItemSubTitle.SetVIf(vif)
	Return Me
End Sub

Sub SetVShow(vif As String) As VMListItemSubTitle
