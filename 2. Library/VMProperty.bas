...
Public Sub Initialize(v As BANanoVue, sid As String, eventHandler As Object) As VMProperty
	...
	sshow = ""
	hasChecks = False
	contChecks.Initialize(vue, "checks", module)
	xmodel = ""
	Return Me
End Sub
