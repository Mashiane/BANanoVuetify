...
Sub SetOnFocus(methodName As String) As VMQuill
	methodName = methodName.tolowercase
	If SubExists(Module, methodName) = False Then Return Me
	Dim e As BANanoEvent
	Dim cb As BANanoObject = BANano.CallBack(Module, methodName, e)
	SetAttrSingle("@focus", methodName)
	'add to methods
...
Sub SetOnTextChange(methodName As String) As VMQuill
	methodName = methodName.tolowercase
	If SubExists(Module, methodName) = False Then Return Me
	Dim e As BANanoEvent
	Dim cb As BANanoObject = BANano.CallBack(Module, methodName, e)
	SetAttrSingle("@text-change", methodName)
	'add to methods
	vue.SetCallBack(methodName, cb)
	Return Me
End Sub
...
Sub SetOnBlur(methodName As String) As VMQuill
	methodName = methodName.tolowercase
	If SubExists(Module, methodName) = False Then Return Me
	Dim e As BANanoEvent
	Dim cb As BANanoObject = BANano.CallBack(Module, methodName, e)
	SetAttrSingle("@blur", methodName)
	'add to methods
	vue.SetCallBack(methodName, cb)
	Return Me
End Sub
...
Sub SetOnSelectionChange(methodName As String) As VMQuill
	methodName = methodName.tolowercase
	If SubExists(Module, methodName) = False Then Return Me
	Dim e As BANanoEvent
	Dim cb As BANanoObject = BANano.CallBack(Module, methodName, e)
	SetAttrSingle("@selection-change", methodName)
	'add to methods
	vue.SetCallBack(methodName, cb)
	Return Me
End Sub
