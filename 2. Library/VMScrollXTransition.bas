...
Sub SetData(xprop As String, xValue As Object) As VMScrollXTransition
...
Sub AddElement(elm As VMElement)
	ScrollXTransition.SetText(elm.ToString)
End Sub


Sub AddElement1(elID As String, elTag As String, elText As String, mprops As Map, mstyles As Map, lclasses As List) As VMScrollXTransition
	Dim d As VMElement
