...
'set text
Sub SetText(t As Object) As VMScrollYReverseTransition
ScrollYReverseTransition.SetText(t)
Return Me
End Sub
...
'set group
Sub SetGroup(varGroup As Object) As VMScrollYReverseTransition
...
'set hide-on-leave
Sub SetHideOnLeave(varHideOnLeave As Object) As VMScrollYReverseTransition
...
'set leave-absolute
Sub SetLeaveAbsolute(varLeaveAbsolute As Object) As VMScrollYReverseTransition
...
'set mode
Sub SetMode(varMode As Object) As VMScrollYReverseTransition
...
'set origin
Sub SetOrigin(varOrigin As Object) As VMScrollYReverseTransition
Dim pp As String = $"${ID}Origin"$
vue.SetStateSingle(pp, varOrigin)
ScrollYReverseTransition.Bind(":origin", pp)
Return Me
End Sub
...
'set color intensity
Sub SetColorIntensity(varColor As String, varIntensity As String) As VMScrollYReverseTransition
	Dim pp As String = $"${ID}Color"$
	Dim scolor As String = $"${varColor} ${varIntensity}"$
	vue.SetStateSingle(pp, scolor)
	ScrollYReverseTransition.Bind(":color", pp)
	Return Me
End Sub
...
'set tab index
Sub SetTabIndex(ti As String) As VMScrollYReverseTransition
	ScrollYReverseTransition.SetTabIndex(ti)
	Return Me
End Sub

'The Select name. Similar To HTML5 name attribute.
Sub SetName(varName As Object, bbind As Boolean) As VMScrollYReverseTransition
...
'set color intensity
Sub SetTextColor(varColor As String) As VMScrollYReverseTransition
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMScrollYReverseTransition
	Dim sColor As String = $"${varColor}--text"$
