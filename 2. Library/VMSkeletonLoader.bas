...
Return Me
End Sub
Sub SetVisible(b As Boolean) As VMSkeletonLoader
SkeletonLoader.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMSkeletonLoader
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMSkeletonLoader
	Dim sColor As String = $"${varColor}--text"$
