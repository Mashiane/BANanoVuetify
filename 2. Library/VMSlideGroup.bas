...
Sub Hide As VMSlideGroup
	SlideGroup.SetVisible(False)
	Return Me
End Sub

'show the component
Sub Show As VMSlideGroup
	SlideGroup.SetVisible(True)
	Return Me
End Sub

'enable the component
Sub Enable As VMSlideGroup
	SlideGroup.Enable(True)
	Return Me
End Sub

'disable the component
Sub Disable As VMSlideGroup
	SlideGroup.Disable(True)
	Return Me
End Sub
...
Sub BuildModel(mprops As Map, mstyles As Map, lclasses As List, loose As List) As VMSlideGroup
...
'set color intensity
Sub SetTextColor(varColor As String) As VMSlideGroup
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMSlideGroup
	Dim sColor As String = $"${varColor}--text"$
