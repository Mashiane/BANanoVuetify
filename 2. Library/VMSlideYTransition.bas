...
Sub AddElement(elm As VMElement)
	SlideYTransition.SetText(elm.ToString)
End Sub


Sub AddElement1(elID As String, elTag As String, elText As String, mprops As Map, mstyles As Map, lclasses As List) As VMSlideYTransition
	Dim d As VMElement
