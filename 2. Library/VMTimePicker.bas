...
Return Me
End Sub
Sub SetVisible(b As Boolean) As VMTimePicker
TimePicker.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMTimePicker
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMTimePicker
	Dim sColor As String = $"${varColor}--text"$
