...
Return Me
End Sub
'Sub SetVisible(b As Boolean) As VMVueCal
VueCal.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMVueCal
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMVueCal
	Dim sColor As String = $"${varColor}--text"$
