...
Sub BuildModel(mprops As Map, mstyles As Map, lclasses As List, loose As List) As VMWaterBall
...
'set color intensity
Sub SetTextColor(varColor As String) As VMWaterBall
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMWaterBall
	Dim sColor As String = $"${varColor}--text"$
