...
Return Me
End Sub
'Sub SetVisible(b As Boolean) As VMZCanvas
ZCanvas.SetVisible(b)
Return Me
End Sub

'set color intensity
Sub SetTextColor(varColor As String) As VMZCanvas
...
'set color intensity
Sub SetTextColorIntensity(varColor As String, varIntensity As String) As VMZCanvas
	Dim sColor As String = $"${varColor}--text"$
