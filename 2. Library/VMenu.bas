...
#DesignerProperty: Key: Auto, DisplayName: Auto, FieldType: Boolean, DefaultValue: False , Description: Centers list on selected element
...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables the menu
...
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue: top left , Description: Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: v-menu-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
Private boAuto As Boolean = False
...
Private stOrigin As String = "top left"
...
Private stTransition As String = "v-menu-transition"
...
'set Centers list on selected element
public Sub setAuto(varAuto As Boolean)
AddAttr("auto", varAuto)
boAuto = varAuto
End Sub

'get Centers list on selected element
public Sub getAuto() As Boolean
Return boAuto
End Sub
