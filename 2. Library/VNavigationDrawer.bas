...
#DesignerProperty: Key: Bottom, DisplayName: Bottom, FieldType: Boolean, DefaultValue: False , Description: Expands from the bottom of the screen on mobile devices
#DesignerProperty: Key: Clipped, DisplayName: Clipped, FieldType: Boolean, DefaultValue: False , Description: A clipped drawer rests under the application toolbar
...
#DesignerProperty: Key: Floating, DisplayName: Floating, FieldType: Boolean, DefaultValue: False , Description: A floating drawer has no visible container no border-right
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 100% , Description: Sets the height of the navigation drawer
...
#DesignerProperty: Key: Permanent, DisplayName: Permanent, FieldType: Boolean, DefaultValue: False , Description: The drawer remains visible regardless of screen size
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: Places the navigation drawer on the right
#DesignerProperty: Key: Src, DisplayName: Src, FieldType: String, DefaultValue:  , Description: Specifies a v-img/components/images as the components background.
#DesignerProperty: Key: Stateless, DisplayName: Stateless, FieldType: Boolean, DefaultValue: False , Description: Remove all automated state functionality resize, mobile, route and manually control the drawer state
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: aside , Description: Specify a custom tag used on the root element.
#DesignerProperty: Key: Temporary, DisplayName: Temporary, FieldType: Boolean, DefaultValue: False , Description: A temporary drawer sits above its application and uses a scrim overlay to darken the background
#DesignerProperty: Key: Touchless, DisplayName: Touchless, FieldType: Boolean, DefaultValue: False , Description: Disable mobile touch functionality
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 256 , Description: Sets the width for the component.
'***** STYLES *****
...
Private boClipped As Boolean = False
...
Private stHeight As String = "100%"
Private stKey As String = ""
Private boLight As Boolean = False
Private stParentId As String = ""
Private boPermanent As Boolean = False
Private stRef As String = ""
Private boRight As Boolean = False
Private stSrc As String = ""
Private boStateless As Boolean = False
Private stTag As String = "aside"
Private boTemporary As Boolean = False
Private boTouchless As Boolean = False
...
boPermanent = Props.Get("Permanent")
stRef = Props.Get("Ref")
boRight = Props.Get("Right")
stSrc = Props.Get("Src")
boStateless = Props.Get("Stateless")
stTag = Props.Get("Tag")
boTemporary = Props.Get("Temporary")
boTouchless = Props.Get("Touchless")
...
AddAttr("permanent", boPermanent)
AddAttr("ref", stRef)
AddAttr("right", boRight)
AddAttr("src", stSrc)
AddAttr("stateless", boStateless)
AddAttr("tag", stTag)
AddAttr("temporary", boTemporary)
AddAttr("touchless", boTouchless)
...
'set Expands from the bottom of the screen on mobile devices
public Sub setBottom(varBottom As Boolean)
AddAttr("bottom", varBottom)
boBottom = varBottom
End Sub

'get Expands from the bottom of the screen on mobile devices
public Sub getBottom() As Boolean
Return boBottom
End Sub

'set A clipped drawer rests under the application toolbar
public Sub setClipped(varClipped As Boolean)
AddAttr("clipped", varClipped)
boClipped = varClipped
End Sub

'get A clipped drawer rests under the application toolbar
public Sub getClipped() As Boolean
Return boClipped
End Sub
...
'set A floating drawer has no visible container no border-right
public Sub setFloating(varFloating As Boolean)
AddAttr("floating", varFloating)
boFloating = varFloating
End Sub

'get A floating drawer has no visible container no border-right
public Sub getFloating() As Boolean
Return boFloating
End Sub

'set Sets the height of the navigation drawer
public Sub setHeight(varHeight As String)
AddAttr("height", varHeight)
stHeight = varHeight
End Sub

'get Sets the height of the navigation drawer
...
'set The drawer remains visible regardless of screen size
public Sub setPermanent(varPermanent As Boolean)
AddAttr("permanent", varPermanent)
boPermanent = varPermanent
End Sub

'get The drawer remains visible regardless of screen size
public Sub getPermanent() As Boolean
Return boPermanent
End Sub
...
'set Places the navigation drawer on the right
public Sub setRight(varRight As Boolean)
AddAttr("right", varRight)
boRight = varRight
End Sub

'get Places the navigation drawer on the right
public Sub getRight() As Boolean
Return boRight
End Sub

'set Specifies a v-img/components/images as the components background.
public Sub setSrc(varSrc As String)
AddAttr("src", varSrc)
stSrc = varSrc
End Sub

'get Specifies a v-img/components/images as the components background.
public Sub getSrc() As String
Return stSrc
End Sub

'set Remove all automated state functionality resize, mobile, route and manually control the drawer state
public Sub setStateless(varStateless As Boolean)
AddAttr("stateless", varStateless)
boStateless = varStateless
End Sub

'get Remove all automated state functionality resize, mobile, route and manually control the drawer state
public Sub getStateless() As Boolean
Return boStateless
End Sub
...
'set A temporary drawer sits above its application and uses a scrim overlay to darken the background
public Sub setTemporary(varTemporary As Boolean)
AddAttr("temporary", varTemporary)
boTemporary = varTemporary
End Sub

'get A temporary drawer sits above its application and uses a scrim overlay to darken the background
public Sub getTemporary() As Boolean
Return boTemporary
End Sub

'set Disable mobile touch functionality
public Sub setTouchless(varTouchless As Boolean)
AddAttr("touchless", varTouchless)
boTouchless = varTouchless
End Sub

'get Disable mobile touch functionality
public Sub getTouchless() As Boolean
Return boTouchless
End Sub
