...
#DesignerProperty: Key: Editable, DisplayName: Editable, FieldType: Boolean, DefaultValue: False , Description: Creates an editable button
...
#DesignerProperty: Key: Segmented, DisplayName: Segmented, FieldType: Boolean, DefaultValue: False , Description: Creates a segmented button
...
Private boSegmented As Boolean = False
...
boSegmented = Props.Get("Segmented")
...
'set Creates a segmented button
public Sub setSegmented(varSegmented As Boolean)
AddAttr("segmented", varSegmented)
boSegmented = varSegmented
End Sub

'get Creates a segmented button
public Sub getSegmented() As Boolean
Return boSegmented
End Sub
