...
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: #212121 , Description: Applies specified color to the control - it can be the name of material color for example `success` or `purple` or css color `#033` or `rgba255, 0, 0, 0.5`. You can find list of built in classes on the colors page/styles/colors#material-colors.
#DesignerProperty: Key: Dark, DisplayName: Dark, FieldType: Boolean, DefaultValue: True , Description: Applies the dark theme variant to the component. You can find more information on the Material Design documentation for dark themeshttps://material.io/design/color/dark-theme.html.
...
#DesignerProperty: Key: Opacity, DisplayName: Opacity, FieldType: String, DefaultValue: 0.46 , Description: Sets the overlay opacity
...
Private stColor As String = "#212121"
Private boDark As Boolean = True
Private stKey As String = ""
Private boLight As Boolean = False
Private stOpacity As String = "0.46"
...
'set Sets the overlay opacity
public Sub setOpacity(varOpacity As String)
AddAttr("opacity", varOpacity)
stOpacity = varOpacity
End Sub

'get Sets the overlay opacity
public Sub getOpacity() As String
Return stOpacity
End Sub
