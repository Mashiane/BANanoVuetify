...
#DesignerProperty: Key: Circle, DisplayName: Circle, FieldType: Boolean, DefaultValue: False , Description: Shape pagination elements as circles
...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables component
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Length, DisplayName: Length, FieldType: String, DefaultValue: 0 , Description: The length of the pagination component
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: 0 , Description: Current selected page
'***** STYLES *****
...
'set Shape pagination elements as circles
public Sub setCircle(varCircle As Boolean)
AddAttr("circle", varCircle)
boCircle = varCircle
End Sub

'get Shape pagination elements as circles
...
'set The length of the pagination component
public Sub setLength(varLength As String)
AddAttr("length", varLength)
stLength = varLength
End Sub

'get The length of the pagination component
