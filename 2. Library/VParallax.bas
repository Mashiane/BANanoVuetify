...
#DesignerProperty: Key: Alt, DisplayName: Alt, FieldType: String, DefaultValue:  , Description: Attaches an alt property to the parallax image
...
#DesignerProperty: Key: Src, DisplayName: Src, FieldType: String, DefaultValue:  , Description: The image to parallax
...
'set Attaches an alt property to the parallax image
public Sub setAlt(varAlt As String)
AddAttr("alt", varAlt)
stAlt = varAlt
End Sub

'get Attaches an alt property to the parallax image
...
'set The image to parallax
public Sub setSrc(varSrc As String)
AddAttr("src", varSrc)
stSrc = varSrc
End Sub

'get The image to parallax
