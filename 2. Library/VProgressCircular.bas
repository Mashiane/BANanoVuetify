...
#DesignerProperty: Key: Button, DisplayName: Button, FieldType: Boolean, DefaultValue: False , Description: Deprecated - Pending removal
...
#DesignerProperty: Key: Rotate, DisplayName: Rotate, FieldType: String, DefaultValue: 0 , Description: Rotates the circle start point in deg
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, DefaultValue: 32 , Description: Sets the diameter of the circle in pixels
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: 0 , Description: The percentage value for current progress
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 4 , Description: Sets the stroke of the circle in pixels
'***** STYLES *****
...
Private boButton As Boolean = False
...
Private stRotate As String = "0"
Private stSize As String = "32"
...
'set Rotates the circle start point in deg
public Sub setRotate(varRotate As String)
AddAttr("rotate", varRotate)
stRotate = varRotate
End Sub

'get Rotates the circle start point in deg
public Sub getRotate() As String
Return stRotate
End Sub

'set Sets the diameter of the circle in pixels
public Sub setSize(varSize As String)
AddAttr("size", varSize)
stSize = varSize
End Sub

'get Sets the diameter of the circle in pixels
...
'set The percentage value for current progress
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get The percentage value for current progress
public Sub getValue() As String
Return stValue
End Sub

'set Sets the stroke of the circle in pixels
public Sub setWidth(varWidth As String)
AddAttr("width", varWidth)
stWidth = varWidth
End Sub

'get Sets the stroke of the circle in pixels
