...
#DesignerProperty: Key: Active, DisplayName: Active, FieldType: Boolean, DefaultValue: True , Description: Reduce the height to 0, hiding component
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 4 , Description: Sets the height for the component
#DesignerProperty: Key: Indeterminate, DisplayName: Indeterminate, FieldType: Boolean, DefaultValue: False , Description: Constantly animates, use when loading progress is unknown.
...
#DesignerProperty: Key: Query, DisplayName: Query, FieldType: Boolean, DefaultValue: False , Description: Animates like **indeterminate** prop but inverse
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Reverse, DisplayName: Reverse, FieldType: Boolean, DefaultValue: False , Description: Displays reversed progress right to left in LTR mode and left to right in RTL
#DesignerProperty: Key: Rounded, DisplayName: Rounded, FieldType: Boolean, DefaultValue: False , Description: Adds a border radius to the progress component
#DesignerProperty: Key: Stream, DisplayName: Stream, FieldType: Boolean, DefaultValue: False , Description: An alternative style for portraying loading that works in tandem with **buffer-value**
#DesignerProperty: Key: Striped, DisplayName: Striped, FieldType: Boolean, DefaultValue: False , Description: Adds a stripe background to the filled portion of the progress component
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: 0 , Description: The designated model value for the component.
'***** STYLES *****
...
boIndeterminate = Props.Get("Indeterminate")
stKey = Props.Get("Key")
boLight = Props.Get("Light")
stParentId = Props.Get("ParentId")
boQuery = Props.Get("Query")
stRef = Props.Get("Ref")
boReverse = Props.Get("Reverse")
boRounded = Props.Get("Rounded")
boStream = Props.Get("Stream")
boStriped = Props.Get("Striped")
boTop = Props.Get("Top")
...
AddAttr("indeterminate", boIndeterminate)
AddAttr("key", stKey)
AddAttr("light", boLight)
AddAttr("parent-id", stParentId)
AddAttr("query", boQuery)
AddAttr("ref", stRef)
AddAttr("reverse", boReverse)
AddAttr("rounded", boRounded)
AddAttr("stream", boStream)
AddAttr("striped", boStriped)
AddAttr("top", boTop)
...
'set Reduce the height to 0, hiding component
public Sub setActive(varActive As Boolean)
AddAttr("active", varActive)
boActive = varActive
End Sub

'get Reduce the height to 0, hiding component
...
'set Constantly animates, use when loading progress is unknown.
public Sub setIndeterminate(varIndeterminate As Boolean)
AddAttr("indeterminate", varIndeterminate)
boIndeterminate = varIndeterminate
End Sub

'get Constantly animates, use when loading progress is unknown.
public Sub getIndeterminate() As Boolean
Return boIndeterminate
End Sub
...
'set Animates like **indeterminate** prop but inverse
public Sub setQuery(varQuery As Boolean)
AddAttr("query", varQuery)
boQuery = varQuery
End Sub

'get Animates like **indeterminate** prop but inverse
public Sub getQuery() As Boolean
Return boQuery
End Sub
...
'set Displays reversed progress right to left in LTR mode and left to right in RTL
public Sub setReverse(varReverse As Boolean)
AddAttr("reverse", varReverse)
boReverse = varReverse
End Sub

'get Displays reversed progress right to left in LTR mode and left to right in RTL
public Sub getReverse() As Boolean
Return boReverse
End Sub

'set Adds a border radius to the progress component
public Sub setRounded(varRounded As Boolean)
AddAttr("rounded", varRounded)
boRounded = varRounded
End Sub

'get Adds a border radius to the progress component
public Sub getRounded() As Boolean
Return boRounded
End Sub

'set An alternative style for portraying loading that works in tandem with **buffer-value**
public Sub setStream(varStream As Boolean)
AddAttr("stream", varStream)
boStream = varStream
End Sub

'get An alternative style for portraying loading that works in tandem with **buffer-value**
public Sub getStream() As Boolean
Return boStream
End Sub

'set Adds a stripe background to the filled portion of the progress component
public Sub setStriped(varStriped As Boolean)
AddAttr("striped", varStriped)
boStriped = varStriped
End Sub

'get Adds a stripe background to the filled portion of the progress component
public Sub getStriped() As Boolean
Return boStriped
End Sub
