...
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: True , Description: Displays radio buttons in column
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Reduces the input height
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disable the input
...
#DesignerProperty: Key: Name, DisplayName: Name, FieldType: String, DefaultValue:  , Description: Sets the components name attribute
...
#DesignerProperty: Key: Row, DisplayName: Row, FieldType: Boolean, DefaultValue: False , Description: Displays radio buttons in row
...
Private boColumn As Boolean = True
...
Private boRow As Boolean = False
...
'set Displays radio buttons in column
public Sub setColumn(varColumn As Boolean)
AddAttr("column", varColumn)
boColumn = varColumn
End Sub

'get Displays radio buttons in column
public Sub getColumn() As Boolean
Return boColumn
End Sub
...
'set Sets the components name attribute
public Sub setName(varName As String)
AddAttr("name", varName)
stName = varName
End Sub

'get Sets the components name attribute
...
'set Displays radio buttons in row
public Sub setRow(varRow As Boolean)
AddAttr("row", varRow)
boRow = varRow
End Sub

'get Displays radio buttons in row
public Sub getRow() As Boolean
Return boRow
End Sub
