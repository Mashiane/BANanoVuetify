...
#DesignerProperty: Key: Max, DisplayName: Max, FieldType: String, DefaultValue: 100 , Description: Sets the maximum allowed value
...
#DesignerProperty: Key: Min, DisplayName: Min, FieldType: String, DefaultValue: 0 , Description: Sets the minimum allowed value
...
#DesignerProperty: Key: Step, DisplayName: Step, FieldType: String, DefaultValue: 1 , Description: If greater than 0, sets step interval for ticks
...
#DesignerProperty: Key: Ticks, DisplayName: Ticks, FieldType: String, DefaultValue: false , Description: Show track ticks. If `true` it shows ticks when using slider. If set to `always` it always shows ticks.
...
#DesignerProperty: Key: Vertical, DisplayName: Vertical, FieldType: Boolean, DefaultValue: False , Description: Changes slider direction to vertical
'***** STYLES *****
...
stRef = Props.Get("Ref")
stStep = Props.Get("Step")
boSuccess = Props.Get("Success")
stTicks = Props.Get("Ticks")
...
'set Sets the maximum allowed value
public Sub setMax(varMax As String)
AddAttr("max", varMax)
stMax = varMax
End Sub

'get Sets the maximum allowed value
...
'set Sets the minimum allowed value
public Sub setMin(varMin As String)
AddAttr("min", varMin)
stMin = varMin
End Sub

'get Sets the minimum allowed value
...
'set If greater than 0, sets step interval for ticks
public Sub setStep(varStep As String)
AddAttr("step", varStep)
stStep = varStep
End Sub

'get If greater than 0, sets step interval for ticks
public Sub getStep() As String
Return stStep
End Sub
...
'set Show track ticks. If `true` it shows ticks when using slider. If set to `always` it always shows ticks.
public Sub setTicks(varTicks As String)
AddAttr("ticks", varTicks)
stTicks = varTicks
End Sub

'get Show track ticks. If `true` it shows ticks when using slider. If set to `always` it always shows ticks.
public Sub getTicks() As String
Return stTicks
End Sub
