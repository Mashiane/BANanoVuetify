...
#DesignerProperty: Key: Clearable, DisplayName: Clearable, FieldType: Boolean, DefaultValue: False , Description: Allows for the component to be cleared. Triggers when the icon containing the current value is clicked.
...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Icons have a smaller size
#DesignerProperty: Key: Hover, DisplayName: Hover, FieldType: Boolean, DefaultValue: False , Description: Provides visual feedback when hovering over icons
...
#DesignerProperty: Key: Length, DisplayName: Length, FieldType: String, DefaultValue: 5 , Description: The amount of ratings to show
...
#DesignerProperty: Key: Readonly, DisplayName: Readonly, FieldType: Boolean, DefaultValue: False , Description: Removes all hover effects and pointer events
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: String, DefaultValue: true , Description: Applies the v-ripple/directives/ripple directive.
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, DefaultValue:  , Description: Sets the height and width of the component.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: 0 , Description: The rating value
'***** STYLES *****
...
'set Allows for the component to be cleared. Triggers when the icon containing the current value is clicked.
public Sub setClearable(varClearable As Boolean)
AddAttr("clearable", varClearable)
boClearable = varClearable
End Sub

'get Allows for the component to be cleared. Triggers when the icon containing the current value is clicked.
...
'set Icons have a smaller size
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Icons have a smaller size
public Sub getDense() As Boolean
Return boDense
End Sub

'set Provides visual feedback when hovering over icons
public Sub setHover(varHover As Boolean)
AddAttr("hover", varHover)
boHover = varHover
End Sub

'get Provides visual feedback when hovering over icons
...
'set The amount of ratings to show
public Sub setLength(varLength As String)
AddAttr("length", varLength)
stLength = varLength
End Sub

'get The amount of ratings to show
public Sub getLength() As String
Return stLength
End Sub
...
'set Removes all hover effects and pointer events
public Sub setReadonly(varReadonly As Boolean)
AddAttr("readonly", varReadonly)
boReadonly = varReadonly
End Sub

'get Removes all hover effects and pointer events
...
'set Sets the height and width of the component.
public Sub setSize(varSize As String)
AddAttr("size", varSize)
stSize = varSize
End Sub

'get Sets the height and width of the component.
