...
#DesignerProperty: Key: Align, DisplayName: Align, FieldType: String, DefaultValue:  , Description: Applies the align-itemshttps://developer.mozilla.org/en-US/docs/Web/CSS/align-items css property. Available options are **start**, **center**, **end**, **baseline** and **stretch**.
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Reduces the gutter between `v-col`s.
#DesignerProperty: Key: Justify, DisplayName: Justify, FieldType: String, DefaultValue:  , Description: Applies the justify-contenthttps://developer.mozilla.org/en-US/docs/Web/CSS/justify-content css property. Available options are **start**, **center**, **end**, **space-between** and **space-around**.
...
'set Applies the align-itemshttps://developer.mozilla.org/en-US/docs/Web/CSS/align-items css property. Available options are **start**, **center**, **end**, **baseline** and **stretch**.
public Sub setAlign(varAlign As String)
AddAttr("align", varAlign)
stAlign = varAlign
End Sub

'get Applies the align-itemshttps://developer.mozilla.org/en-US/docs/Web/CSS/align-items css property. Available options are **start**, **center**, **end**, **baseline** and **stretch**.
public Sub getAlign() As String
Return stAlign
End Sub

'set Reduces the gutter between `v-col`s.
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Reduces the gutter between `v-col`s.
public Sub getDense() As Boolean
Return boDense
End Sub

'set Applies the justify-contenthttps://developer.mozilla.org/en-US/docs/Web/CSS/justify-content css property. Available options are **start**, **center**, **end**, **space-between** and **space-around**.
public Sub setJustify(varJustify As String)
AddAttr("justify", varJustify)
stJustify = varJustify
End Sub

'get Applies the justify-contenthttps://developer.mozilla.org/en-US/docs/Web/CSS/justify-content css property. Available options are **start**, **center**, **end**, **space-between** and **space-around**.
