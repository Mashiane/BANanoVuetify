...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables simple checkbox.
#DesignerProperty: Key: Indeterminate, DisplayName: Indeterminate, FieldType: Boolean, DefaultValue: False , Description: Sets an indeterminate state for the simple checkbox.
...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: Boolean, DefaultValue: True , Description: Applies the v-ripple/directives/ripple directive.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: False , Description: A boolean value that represents whether the simple checkbox is checked.
'***** STYLES *****
...
Private boRipple As Boolean = True
...
Private boValue As Boolean = False
...
'get Sets an indeterminate state for the simple checkbox.
...
'set A boolean value that represents whether the simple checkbox is checked.
public Sub setValue(varValue As Boolean)
AddAttr("value", varValue)
boValue = varValue
End Sub

'get A boolean value that represents whether the simple checkbox is checked.
