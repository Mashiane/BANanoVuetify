...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Decreases paddings to render a dense table
...
'set Decreases paddings to render a dense table
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Decreases paddings to render a dense table
