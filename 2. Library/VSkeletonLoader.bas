...
#DesignerProperty: Key: Boilerplate, DisplayName: Boilerplate, FieldType: Boolean, DefaultValue: False , Description: Remove the loading animation from the skeleton
...
#DesignerProperty: Key: Loading, DisplayName: Loading, FieldType: Boolean, DefaultValue: False , Description: Applies a loading animation with a on-hover loading cursor. A value of **false** will only work when there is content in the `default` slot.
...
#DesignerProperty: Key: Types, DisplayName: Types, FieldType: String, DefaultValue:  , Description: A custom types object that will be combined with the pre-defined options. For a list of available pre-defined options, see the **type** prop.
...
Private boBoilerplate As Boolean = False
...
boBoilerplate = Props.Get("Boilerplate")
...
AddAttr("boilerplate", boBoilerplate)
AddAttr("dark", boDark)
...
'set Remove the loading animation from the skeleton
public Sub setBoilerplate(varBoilerplate As Boolean)
AddAttr("boilerplate", varBoilerplate)
boBoilerplate = varBoilerplate
End Sub

'get Remove the loading animation from the skeleton
public Sub getBoilerplate() As Boolean
Return boBoilerplate
End Sub
...
'set Applies a loading animation with a on-hover loading cursor. A value of **false** will only work when there is content in the `default` slot.
public Sub setLoading(varLoading As Boolean)
AddAttr("loading", varLoading)
boLoading = varLoading
End Sub

'get Applies a loading animation with a on-hover loading cursor. A value of **false** will only work when there is content in the `default` slot.
...
'set A custom types object that will be combined with the pre-defined options. For a list of available pre-defined options, see the **type** prop.
public Sub setTypes(varTypes As String)
AddAttr("types", varTypes)
stTypes = varTypes
End Sub

'get A custom types object that will be combined with the pre-defined options. For a list of available pre-defined options, see the **type** prop.
