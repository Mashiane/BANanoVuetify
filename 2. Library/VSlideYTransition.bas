...
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue: top center 0 , Description: Sets the transition origin on the element. You can find more information on the MDN documentation for transition originhttps://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin.
...
Private stOrigin As String = "top center 0"
