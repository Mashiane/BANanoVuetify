...
#DesignerProperty: Key: App, DisplayName: App, FieldType: Boolean, DefaultValue: False , Description: Respects boundaries of—and will not overlap with—other `app` components like `v-app-bar`, `v-navigation-drawer`, and `v-footer`.
...
#DesignerProperty: Key: Centered, DisplayName: Centered, FieldType: Boolean, DefaultValue: False , Description: Positions the snackbar in the center of the screen, x and y axis.
...
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: Aligns the component towards the right.
...
#DesignerProperty: Key: Timeout, DisplayName: Timeout, FieldType: String, DefaultValue: 5000 , Description: Time in milliseconds to wait until snackbar is automatically hidden.  Use `-1` to keep open indefinitely `0` in version < 2.3 . It is recommended for this number to be between `4000` and `10000`. Changes to this property will reset the timeout.
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: v-snack-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
#DesignerProperty: Key: Vertical, DisplayName: Vertical, FieldType: Boolean, DefaultValue: False , Description: Stacks snackbar content on top of the actions button.
...
Private boApp As Boolean = False
...
Private stTimeout As String = "5000"
Private boTop As Boolean = False
Private stTransition As String = "v-snack-transition"
...
'set Respects boundaries of—and will not overlap with—other `app` components like `v-app-bar`, `v-navigation-drawer`, and `v-footer`.
public Sub setApp(varApp As Boolean)
AddAttr("app", varApp)
boApp = varApp
End Sub

'get Respects boundaries of—and will not overlap with—other `app` components like `v-app-bar`, `v-navigation-drawer`, and `v-footer`.
public Sub getApp() As Boolean
Return boApp
End Sub
...
'set Positions the snackbar in the center of the screen, x and y axis.
public Sub setCentered(varCentered As Boolean)
AddAttr("centered", varCentered)
boCentered = varCentered
End Sub

'get Positions the snackbar in the center of the screen, x and y axis.
...
'set Aligns the component towards the right.
public Sub setRight(varRight As Boolean)
AddAttr("right", varRight)
boRight = varRight
End Sub

'get Aligns the component towards the right.
...
'set Time in milliseconds to wait until snackbar is automatically hidden.  Use `-1` to keep open indefinitely `0` in version < 2.3 . It is recommended for this number to be between `4000` and `10000`. Changes to this property will reset the timeout.
public Sub setTimeout(varTimeout As String)
AddAttr("timeout", varTimeout)
stTimeout = varTimeout
End Sub

'get Time in milliseconds to wait until snackbar is automatically hidden.  Use `-1` to keep open indefinitely `0` in version < 2.3 . It is recommended for this number to be between `4000` and `10000`. Changes to this property will reset the timeout.
public Sub getTimeout() As String
Return stTimeout
End Sub
...
'set Stacks snackbar content on top of the actions button.
public Sub setVertical(varVertical As Boolean)
AddAttr("vertical", varVertical)
boVertical = varVertical
End Sub

'get Stacks snackbar content on top of the actions button.
