...
#DesignerProperty: Key: Fill, DisplayName: Fill, FieldType: Boolean, DefaultValue: False , Description: Using the **fill** property allows you to better customize the look and feel of your sparkline.
#DesignerProperty: Key: Gradient, DisplayName: Gradient, FieldType: String, DefaultValue:  , Description: An array of colors to use as a linear-gradient
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 75 , Description: Height of the SVG trendline or bars
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Labels, DisplayName: Labels, FieldType: String, DefaultValue:  , Description: An array of string labels that correspond to the same index as its data counterpart
#DesignerProperty: Key: Padding, DisplayName: Padding, FieldType: String, DefaultValue: 8 , Description: Low `smooth` or high `line-width` values may result in cropping, increase padding to compensate
...
#DesignerProperty: Key: Smooth, DisplayName: Smooth, FieldType: String, DefaultValue: false , Description: Number of px to use as a corner radius. `true` defaults to 8, `false` is 0
#DesignerProperty: Key: TypeOf, DisplayName: TypeOf, FieldType: String, DefaultValue: trend , Description: Choose between a trendline or bars
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: An array of numbers.
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 300 , Description: Width of the SVG trendline or bars
'***** STYLES *****
...
Private boFill As Boolean = False
Private stGradient As String = ""
Private stHeight As String = "75"
Private stKey As String = ""
Private stLabels As String = ""
Private stPadding As String = "8"
Private stParentId As String = ""
Private stRef As String = ""
Private stSmooth As String = "false"
Private stTypeOf As String = "trend"
...
'set Using the **fill** property allows you to better customize the look and feel of your sparkline.
public Sub setFill(varFill As Boolean)
AddAttr("fill", varFill)
boFill = varFill
End Sub

'get Using the **fill** property allows you to better customize the look and feel of your sparkline.
public Sub getFill() As Boolean
Return boFill
End Sub

'set An array of colors to use as a linear-gradient
public Sub setGradient(varGradient As String)
AddAttr("gradient", varGradient)
stGradient = varGradient
End Sub

'get An array of colors to use as a linear-gradient
public Sub getGradient() As String
Return stGradient
End Sub

'set Height of the SVG trendline or bars
public Sub setHeight(varHeight As String)
AddAttr("height", varHeight)
stHeight = varHeight
End Sub

'get Height of the SVG trendline or bars
...
'set An array of string labels that correspond to the same index as its data counterpart
public Sub setLabels(varLabels As String)
AddAttr("labels", varLabels)
stLabels = varLabels
End Sub

'get An array of string labels that correspond to the same index as its data counterpart
public Sub getLabels() As String
Return stLabels
End Sub

'set Low `smooth` or high `line-width` values may result in cropping, increase padding to compensate
public Sub setPadding(varPadding As String)
AddAttr("padding", varPadding)
stPadding = varPadding
End Sub

'get Low `smooth` or high `line-width` values may result in cropping, increase padding to compensate
...
'set Number of px to use as a corner radius. `true` defaults to 8, `false` is 0
public Sub setSmooth(varSmooth As String)
AddAttr("smooth", varSmooth)
stSmooth = varSmooth
End Sub

'get Number of px to use as a corner radius. `true` defaults to 8, `false` is 0
public Sub getSmooth() As String
Return stSmooth
End Sub

'set Choose between a trendline or bars
public Sub setTypeOf(varTypeOf As String)
AddAttr("type", varTypeOf)
stTypeOf = varTypeOf
End Sub

'get Choose between a trendline or bars
...
'set Width of the SVG trendline or bars
public Sub setWidth(varWidth As String)
AddAttr("width", varWidth)
stWidth = varWidth
End Sub

'get Width of the SVG trendline or bars
