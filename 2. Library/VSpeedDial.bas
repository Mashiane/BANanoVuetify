...
#DesignerProperty: Key: Direction, DisplayName: Direction, FieldType: String, DefaultValue: top , Description: Direction in which speed-dial content will show. Possible values are `top`, `bottom`, `left`, `right`.
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: scale-transition , Description: Sets the component transition. Can be one of the built in transitions/styles/transitions or one your own.
...
Private stDirection As String = "top"
...
Private stTransition As String = "scale-transition"
...
'set Direction in which speed-dial content will show. Possible values are `top`, `bottom`, `left`, `right`.
public Sub setDirection(varDirection As String)
AddAttr("direction", varDirection)
stDirection = varDirection
End Sub

'get Direction in which speed-dial content will show. Possible values are `top`, `bottom`, `left`, `right`.
