...
#DesignerProperty: Key: Step, DisplayName: Step, FieldType: String, DefaultValue:  , Description: Sets step to associate the content to
...
'set Sets step to associate the content to
public Sub setStep(varStep As String)
AddAttr("step", varStep)
stStep = varStep
End Sub

'get Sets step to associate the content to
