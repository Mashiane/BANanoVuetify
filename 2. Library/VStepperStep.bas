...
#DesignerProperty: Key: Complete, DisplayName: Complete, FieldType: Boolean, DefaultValue: False , Description: Marks step as complete
#DesignerProperty: Key: Editable, DisplayName: Editable, FieldType: Boolean, DefaultValue: False , Description: Marks step as editable
...
#DesignerProperty: Key: Step, DisplayName: Step, FieldType: String, DefaultValue:  , Description: Content to display inside step circle
...
Private boComplete As Boolean = False
Private boEditable As Boolean = False
Private stKey As String = ""
Private stParentId As String = ""
Private stRef As String = ""
Private stStep As String = ""
...
boComplete = Props.Get("Complete")
boEditable = Props.Get("Editable")
stKey = Props.Get("Key")
...
AddAttr("complete", boComplete)
AddAttr("editable", boEditable)
AddAttr("key", stKey)
...
'set Marks step as complete
public Sub setComplete(varComplete As Boolean)
AddAttr("complete", varComplete)
boComplete = varComplete
End Sub

'get Marks step as complete
public Sub getComplete() As Boolean
Return boComplete
End Sub

'set Marks step as editable
public Sub setEditable(varEditable As Boolean)
AddAttr("editable", varEditable)
boEditable = varEditable
End Sub

'get Marks step as editable
...
'set Content to display inside step circle
public Sub setStep(varStep As String)
AddAttr("step", varStep)
stStep = varStep
End Sub

'get Content to display inside step circle
