...
#DesignerProperty: Key: Flat, DisplayName: Flat, FieldType: Boolean, DefaultValue: False , Description: Display component without elevation. Default elevation for thumb is 4dp, `flat` resets it
#DesignerProperty: Key: Hint, DisplayName: Hint, FieldType: String, DefaultValue:  , Description: Hint text
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: Enlarge the `v-switch` track to encompass the thumb
...
#DesignerProperty: Key: Multiple, DisplayName: Multiple, FieldType: Boolean, DefaultValue: False , Description: Changes expected model to an array
...
'set Display component without elevation. Default elevation for thumb is 4dp, `flat` resets it
public Sub setFlat(varFlat As Boolean)
AddAttr("flat", varFlat)
boFlat = varFlat
End Sub

'get Display component without elevation. Default elevation for thumb is 4dp, `flat` resets it
...
'set Enlarge the `v-switch` track to encompass the thumb
public Sub setInset(varInset As Boolean)
AddAttr("inset", varInset)
boInset = varInset
End Sub

'get Enlarge the `v-switch` track to encompass the thumb
