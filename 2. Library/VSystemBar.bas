...
#DesignerProperty: Key: Window, DisplayName: Window, FieldType: Boolean, DefaultValue: False , Description: Increases the system bar height to 32px 24px default.
'***** STYLES *****
...
Private boWindow As Boolean = False
...
'set Increases the system bar height to 32px 24px default.
public Sub setWindow(varWindow As Boolean)
AddAttr("window", varWindow)
boWindow = varWindow
End Sub

'get Increases the system bar height to 32px 24px default.
public Sub getWindow() As Boolean
Return boWindow
End Sub
