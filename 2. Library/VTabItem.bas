...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Sets the value of the tab. If not provided, the index will be used.
'***** STYLES *****
...
'set Sets the value of the tab. If not provided, the index will be used.
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Sets the value of the tab. If not provided, the index will be used.
