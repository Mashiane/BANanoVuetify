...
#DesignerProperty: Key: Continuous, DisplayName: Continuous, FieldType: Boolean, DefaultValue: False , Description: If `true`, window will wrap around from the last item to the first, and from the first item to the last
...
Private boContinuous As Boolean = False
...
'set If `true`, window will wrap around from the last item to the first, and from the first item to the last
public Sub setContinuous(varContinuous As Boolean)
AddAttr("continuous", varContinuous)
boContinuous = varContinuous
End Sub

'get If `true`, window will wrap around from the last item to the first, and from the first item to the last
