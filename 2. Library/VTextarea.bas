...
#DesignerProperty: Key: Rows, DisplayName: Rows, FieldType: String, DefaultValue: 5 , Description: Default row count
...
public Sub setRows(varRows As String)
AddAttr("rows", varRows)
stRows = varRows
End Sub

'get Default row count
public Sub getRows() As String
Return stRows
End Sub
