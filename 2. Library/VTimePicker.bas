...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: disables picker
...
#DesignerProperty: Key: Format, DisplayName: Format, FieldType: String, DefaultValue: ampm , Description: Defines the format of a time displayed in picker. Available options are `ampm` and `24hr`.
...
#DesignerProperty: Key: Max, DisplayName: Max, FieldType: String, DefaultValue:  , Description: Maximum allowed time
#DesignerProperty: Key: Min, DisplayName: Min, FieldType: String, DefaultValue:  , Description: Minimum allowed time
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Readonly, DisplayName: Readonly, FieldType: Boolean, DefaultValue: False , Description: Puts picker in readonly state
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Scrollable, DisplayName: Scrollable, FieldType: Boolean, DefaultValue: False , Description: Allows changing hour/minute with mouse scroll
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: Time picker model ISO 8601 format, 24hr hh:mm
...
Private stFormat As String = "ampm"
...
'set Defines the format of a time displayed in picker. Available options are `ampm` and `24hr`.
public Sub setFormat(varFormat As String)
AddAttr("format", varFormat)
stFormat = varFormat
End Sub

'get Defines the format of a time displayed in picker. Available options are `ampm` and `24hr`.
...
'set Time picker model ISO 8601 format, 24hr hh:mm
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get Time picker model ISO 8601 format, 24hr hh:mm
