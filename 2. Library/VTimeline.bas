...
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: Hide opposite slot content, and position all items to one side of timeline
...
#DesignerProperty: Key: Reverse, DisplayName: Reverse, FieldType: Boolean, DefaultValue: False , Description: Reverse direction of timeline items
...
'set Hide opposite slot content, and position all items to one side of timeline
public Sub setDense(varDense As Boolean)
AddAttr("dense", varDense)
boDense = varDense
End Sub

'get Hide opposite slot content, and position all items to one side of timeline
