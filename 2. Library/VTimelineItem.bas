...
#DesignerProperty: Key: Icon, DisplayName: Icon, FieldType: String, DefaultValue:  , Description: Specify icon for dot container
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Large, DisplayName: Large, FieldType: Boolean, DefaultValue: False , Description: Large size dot
#DesignerProperty: Key: Left, DisplayName: Left, FieldType: Boolean, DefaultValue: False , Description: Explicitly set the item to a left orientation
...
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: Explicitly set the item to a right orientation
#DesignerProperty: Key: Small, DisplayName: Small, FieldType: Boolean, DefaultValue: False , Description: Small size dot
...
'set Specify icon for dot container
public Sub setIcon(varIcon As String)
AddAttr("icon", varIcon)
stIcon = varIcon
End Sub

'get Specify icon for dot container
...
'set Explicitly set the item to a left orientation
public Sub setLeft(varLeft As Boolean)
AddAttr("left", varLeft)
boLeft = varLeft
End Sub

'get Explicitly set the item to a left orientation
...
'set Explicitly set the item to a right orientation
public Sub setRight(varRight As Boolean)
AddAttr("right", varRight)
boRight = varRight
End Sub

'get Explicitly set the item to a right orientation
