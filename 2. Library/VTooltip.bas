...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Disables the tooltip
...
#DesignerProperty: Key: Fixed, DisplayName: Fixed, FieldType: Boolean, DefaultValue: True , Description: Applies **position: fixed** to the component.
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: span , Description: Specifies a custom tag for the activator wrapper
...
Private boFixed As Boolean = True
...
'set Specifies a custom tag for the activator wrapper
public Sub setTag(varTag As String)
AddAttr("tag", varTag)
stTag = varTag
End Sub

'get Specifies a custom tag for the activator wrapper
