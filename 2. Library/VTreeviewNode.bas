...
#DesignerProperty: Key: Item, DisplayName: Item, FieldType: String, DefaultValue:  , Description: Item object used to build the node
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Level, DisplayName: Level, FieldType: String, DefaultValue:  , Description: Property designating how deep the node is from the root of the treeview
...
Private stItem As String = ""
Private stKey As String = ""
Private stLevel As String = ""
...
stItem = Props.Get("Item")
stKey = Props.Get("Key")
stLevel = Props.Get("Level")
...
'set Item object used to build the node
public Sub setItem(varItem As String)
AddAttr("item", varItem)
stItem = varItem
End Sub

'get Item object used to build the node
public Sub getItem() As String
Return stItem
End Sub
...
'set Property designating how deep the node is from the root of the treeview
public Sub setLevel(varLevel As String)
AddAttr("level", varLevel)
stLevel = varLevel
End Sub

'get Property designating how deep the node is from the root of the treeview
public Sub getLevel() As String
Return stLevel
End Sub
