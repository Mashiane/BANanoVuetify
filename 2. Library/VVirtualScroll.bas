...
#DesignerProperty: Key: Bench, DisplayName: Bench, FieldType: String, DefaultValue: 0 , Description: The number of items **outside** the user view that are rendered even if they are **not** viewable; to help prevent empty white space when scrolling *fast*.
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue:  , Description: Height of the component as a css value
...
'set The number of items **outside** the user view that are rendered even if they are **not** viewable; to help prevent empty white space when scrolling *fast*.
public Sub setBench(varBench As String)
AddAttr("bench", varBench)
stBench = varBench
End Sub

'get The number of items **outside** the user view that are rendered even if they are **not** viewable; to help prevent empty white space when scrolling *fast*.
public Sub getBench() As String
Return stBench
End Sub

'set Height of the component as a css value
public Sub setHeight(varHeight As String)
AddAttr("height", varHeight)
stHeight = varHeight
End Sub

'get Height of the component as a css value
