...
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: Prevents the item from becoming active when using the next and prev buttons or the `toggle` method
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue:  , Description: The transition used when the component progressing through items. Can be one of the built in transitions/styles/transitions or one your own.
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: The value used when the component is selected in a group. If not provided, the index will be used.
'***** STYLES *****
...
'set Prevents the item from becoming active when using the next and prev buttons or the `toggle` method
public Sub setDisabled(varDisabled As Boolean)
AddAttr("disabled", varDisabled)
boDisabled = varDisabled
End Sub

'get Prevents the item from becoming active when using the next and prev buttons or the `toggle` method
...
'set The transition used when the component progressing through items. Can be one of the built in transitions/styles/transitions or one your own.
public Sub setTransition(varTransition As String)
AddAttr("transition", varTransition)
stTransition = varTransition
End Sub

'get The transition used when the component progressing through items. Can be one of the built in transitions/styles/transitions or one your own.
...
'set The value used when the component is selected in a group. If not provided, the index will be used.
public Sub setValue(varValue As String)
AddAttr("value", varValue)
stValue = varValue
End Sub

'get The value used when the component is selected in a group. If not provided, the index will be used.
