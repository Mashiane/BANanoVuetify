...
Public Sub Initialize(v As BANanoVue, sid As String, eventHandler As Object) As VMCircleCounter
	...
	vue = v
	'
	If vue.ModuleExist("circlecounter") = False Then
		CC.Initialize("circleCounter")
		vue.AddComponentBO("circle-counter", CC)
		vue.AddModule("circlecounter")
	End If
	Return Me
End Sub
...
Sub SetCenterOnParent(b As Boolean) As VMCircleCounter
	If b = False Then Return Me
	CircleCounter.CenterOnParent = True
	Return Me
End Sub
