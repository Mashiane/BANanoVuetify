...
public class modcolorpicker extends Object{
public static modcolorpicker mostCurrent = new modcolorpicker();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.modcolorpicker", null);
		ba.loadHtSubs(modcolorpicker.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.modcolorpicker", ba);
		}
	}
    public static Class<?> getObject() {
		return modcolorpicker.class;
	}
...
b4j.example.vmcolorpicker _cp = null;
b4j.example.vmcolorpicker _cp2 = null;
b4j.example.vmcolorpicker _cp3 = null;
b4j.example.vmcolorpicker _cp4 = null;
...
_cont = _vm._createcontainer /*b4j.example.vmcontainer*/ (_name,modcolorpicker.getObject());
...
_cont._addrows /*b4j.example.vmcontainer*/ ((int) (5))._addcolumns2x6 /*b4j.example.vmcontainer*/ ();
 //BA.debugLineNum = 18;BA.debugLine="Dim cp As VMColorPicker = vm.CreateColorPicker(\"c";
_cp = _vm._createcolorpicker /*b4j.example.vmcolorpicker*/ ("cp1",modcolorpicker.getObject())._setvmodel /*b4j.example.vmcolorpicker*/ ("mycolor");
 //BA.debugLineNum = 19;BA.debugLine="cont.AddComponent(1, 1, cp.tostring)";
_cont._addcomponent /*String*/ ((int) (1),(int) (1),_cp._tostring /*String*/ ());
 //BA.debugLineNum = 21;BA.debugLine="cont.AddLabel(1, 2, \"cpx\", vm.SIZE_P , \"{{ mycolo";
_cont._addlabel /*b4j.example.vmcontainer*/ ((int) (1),(int) (2),"cpx",_vm._size_p /*String*/ ,"{{ mycolor }}");
 //BA.debugLineNum = 23;BA.debugLine="Dim cp2 As VMColorPicker = vm.CreateColorPicker(\"";
_cp2 = _vm._createcolorpicker /*b4j.example.vmcolorpicker*/ ("cp2",modcolorpicker.getObject())._setvmodel /*b4j.example.vmcolorpicker*/ ("mycolor")._sethidecanvas /*b4j.example.vmcolorpicker*/ ((Object)(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 24;BA.debugLine="cp2.SetHideInputs(True).SetHideModeSwitch(True)";
_cp2._sethideinputs /*b4j.example.vmcolorpicker*/ ((Object)(anywheresoftware.b4a.keywords.Common.True))._sethidemodeswitch /*b4j.example.vmcolorpicker*/ ((Object)(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 25;BA.debugLine="cont.AddComponent(2, 1, cp2.tostring)";
_cont._addcomponent /*String*/ ((int) (2),(int) (1),_cp2._tostring /*String*/ ());
 //BA.debugLineNum = 27;BA.debugLine="Dim cp3 As VMColorPicker = vm.CreateColorPicker(\"";
_cp3 = _vm._createcolorpicker /*b4j.example.vmcolorpicker*/ ("cp3",modcolorpicker.getObject())._setvmodel /*b4j.example.vmcolorpicker*/ ("mycolor")._setcanvasheight /*b4j.example.vmcolorpicker*/ ((Object)("300"));
 //BA.debugLineNum = 28;BA.debugLine="cont.AddComponent(2, 2, cp3.tostring)";
_cont._addcomponent /*String*/ ((int) (2),(int) (2),_cp3._tostring /*String*/ ());
 //BA.debugLineNum = 30;BA.debugLine="Dim cp4 As VMColorPicker = vm.CreateColorPicker(\"";
_cp4 = _vm._createcolorpicker /*b4j.example.vmcolorpicker*/ ("cp4",modcolorpicker.getObject())._setvmodel /*b4j.example.vmcolorpicker*/ ("mycolor")._setdotsize /*b4j.example.vmcolorpicker*/ ((Object)("30"))._setshowswatches /*b4j.example.vmcolorpicker*/ ((Object)(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 31;BA.debugLine="cont.AddComponent(3, 1, cp4.tostring)";
_cont._addcomponent /*String*/ ((int) (3),(int) (1),_cp4._tostring /*String*/ ());
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 3;BA.debugLine="Public name As String = \"colorPickerCode\"";
_name = "colorPickerCode";
 //BA.debugLineNum = 4;BA.debugLine="Public title As String = \"Color Picker\"";
_title = "Color Picker";
