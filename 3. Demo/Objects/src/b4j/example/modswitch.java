...
_cont._addrows /*b4j.example.vmcontainer*/ ((int) (10))._addcolumns2x6 /*b4j.example.vmcontainer*/ ();
 //BA.debugLineNum = 18;BA.debugLine="vm.CreateSwitch(\"sw1\", Me).SetLabel(\"Switch 1\").S";
_vm._createswitch /*b4j.example.vmcheckbox*/ ("sw1",modswitch.getObject())._setlabel /*b4j.example.vmcheckbox*/ ("Switch 1")._setvmodel /*b4j.example.vmcheckbox*/ ("sw1")._setonchange /*b4j.example.vmcheckbox*/ (modswitch.getObject(),"sw1_change")._setcolorintensity /*b4j.example.vmcheckbox*/ (_vm._vue /*b4j.example.bananovue*/ ._color_indigo /*String*/ ,_vm._vue /*b4j.example.bananovue*/ ._intensity_darken4 /*String*/ )._addtocontainer /*String*/ (_cont,(int) (1),(int) (1));
 //BA.debugLineNum = 19;BA.debugLine="vm.CreateLABEL(\"lbl2\").SetText(\"{{ sw1 }}\").AddTo";
_vm._createlabel /*b4j.example.vmlabel*/ ("lbl2")._settext /*b4j.example.vmlabel*/ ("{{ sw1 }}")._addtocontainer /*String*/ (_cont,(int) (1),(int) (2));
 //BA.debugLineNum = 21;BA.debugLine="vm.CreateSwitch(\"sw2\", Me).SetLabel(\"Switch 2\").S";
_vm._createswitch /*b4j.example.vmcheckbox*/ ("sw2",modswitch.getObject())._setlabel /*b4j.example.vmcheckbox*/ ("Switch 2")._setvmodel /*b4j.example.vmcheckbox*/ ("sw2")._addtocontainer /*String*/ (_cont,(int) (2),(int) (1));
 //BA.debugLineNum = 22;BA.debugLine="vm.CreateLABEL(\"lbl3\").SetText(\"{{ sw2 }}\").AddTo";
_vm._createlabel /*b4j.example.vmlabel*/ ("lbl3")._settext /*b4j.example.vmlabel*/ ("{{ sw2 }}")._addtocontainer /*String*/ (_cont,(int) (2),(int) (2));
 //BA.debugLineNum = 24;BA.debugLine="vm.CreateSwitch(\"sw3\", Me).SetLabel(\"Switch 3\").S";
_vm._createswitch /*b4j.example.vmcheckbox*/ ("sw3",modswitch.getObject())._setlabel /*b4j.example.vmcheckbox*/ ("Switch 3")._setvmodel /*b4j.example.vmcheckbox*/ ("sw3")._setvalue /*b4j.example.vmcheckbox*/ (BA.ObjectToString(anywheresoftware.b4a.keywords.Common.True))._setfalsevalue /*b4j.example.vmcheckbox*/ ("No")._setinputvalue /*b4j.example.vmcheckbox*/ ((Object)("Yes"))._setinset /*b4j.example.vmcheckbox*/ (anywheresoftware.b4a.keywords.Common.True)._addtocontainer /*String*/ (_cont,(int) (3),(int) (1));
 //BA.debugLineNum = 25;BA.debugLine="vm.CreateLABEL(\"lbl4\").SetText(\"{{ sw3 }}\").AddTo";
_vm._createlabel /*b4j.example.vmlabel*/ ("lbl4")._settext /*b4j.example.vmlabel*/ ("{{ sw3 }}")._addtocontainer /*String*/ (_cont,(int) (3),(int) (2));
 //BA.debugLineNum = 27;BA.debugLine="vm.CreateSwitch(\"sw5\", Me).SetLabel(\"Switch 4\").S";
_vm._createswitch /*b4j.example.vmcheckbox*/ ("sw5",modswitch.getObject())._setlabel /*b4j.example.vmcheckbox*/ ("Switch 4")._setloading /*b4j.example.vmcheckbox*/ ("warning")._addtocontainer /*String*/ (_cont,(int) (4),(int) (1));
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 3;BA.debugLine="Public name As String = \"switchCode\"";
_name = "switchCode";
 //BA.debugLineNum = 4;BA.debugLine="Public title As String = \"Switch box\"";
_title = "Switch box";
...
public static String  _sw1_change(Object _value) throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub sw1_change(value As Object)";
 //BA.debugLineNum = 35;BA.debugLine="vm.ShowSnackBar($\"sw1_change: ${value}\"$)";
_vm._showsnackbar /*String*/ (("sw1_change: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",_value)+""));
