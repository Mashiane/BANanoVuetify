...
b4j.example.vmdatetimepicker _tp1 = null;
...
_cont._addrows /*b4j.example.vmcontainer*/ ((int) (5))._addcolumns2x6 /*b4j.example.vmcontainer*/ ();
 //BA.debugLineNum = 18;BA.debugLine="Dim tp2 As VMDateTimePicker = vm.CreateTimePicker";
_tp2 = _vm._createtimepicker /*b4j.example.vmdatetimepicker*/ ("tp2",modtimepicker.getObject())._setvmodel /*b4j.example.vmdatetimepicker*/ ("tp2")._setlabel /*b4j.example.vmdatetimepicker*/ ("Time of Birth")._setforinput /*b4j.example.vmdatetimepicker*/ ();
 //BA.debugLineNum = 19;BA.debugLine="tp2.AddToContainer(cont, 1, 1)";
_tp2._addtocontainer /*String*/ (_cont,(int) (1),(int) (1));
 //BA.debugLineNum = 21;BA.debugLine="vm.CreateLabel(\"lblt\").SetParagraph.SetText(\"Time";
_vm._createlabel /*b4j.example.vmlabel*/ ("lblt")._setparagraph /*b4j.example.vmlabel*/ ()._settext /*b4j.example.vmlabel*/ ("Time: {{ tp2 }}")._addtocontainer /*String*/ (_cont,(int) (1),(int) (2));
 //BA.debugLineNum = 23;BA.debugLine="Dim tp1 As VMDateTimePicker = vm.CreateTimePicker";
_tp1 = _vm._createtimepicker /*b4j.example.vmdatetimepicker*/ ("tp1",modtimepicker.getObject())._setvmodel /*b4j.example.vmdatetimepicker*/ ("tp1")._set24 /*b4j.example.vmdatetimepicker*/ ();
 //BA.debugLineNum = 24;BA.debugLine="tp1.AddToContainer(cont, 2, 1)";
_tp1._addtocontainer /*String*/ (_cont,(int) (2),(int) (1));
 //BA.debugLineNum = 26;BA.debugLine="vm.CreateLabel(\"lblx\").SetParagraph.SetText(\"Time";
_vm._createlabel /*b4j.example.vmlabel*/ ("lblx")._setparagraph /*b4j.example.vmlabel*/ ()._settext /*b4j.example.vmlabel*/ ("Time: {{ tp1 }}")._addtocontainer /*String*/ (_cont,(int) (2),(int) (2));
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 3;BA.debugLine="Public name As String = \"timePickerCode\"";
_name = "timePickerCode";
 //BA.debugLineNum = 4;BA.debugLine="Public title As String = \"Time Picker\"";
_title = "Time Picker";
