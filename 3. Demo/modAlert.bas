...
Sub Code
	...
	Main.CreateVBCode(vue, "a1code", "Alert", $"vm.CreateAlert("a1", Me, "success").SetContent("I'm a success alert.").Show.AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 1, 1)
	'
	vm.CreateAlert("a2", Me, "info").SetContent("I'm an info alert.").Show.AddToContainer(cont, 2, 1)
	Main.CreateVBCode(vue, "a2code", "Alert", $"vm.CreateAlert("a2", Me, "info").SetContent("I'm an info alert.").AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 2, 1)
	'
	vm.CreateAlert("a3", Me, "warning").SetContent("I'm a warning alert.").Show.AddToContainer(cont, 3, 1)
	Main.CreateVBCode(vue, "a3code", "Alert", $"vm.CreateAlert("a3", Me, "warning").SetContent("I'm a warning alert.").AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 3, 1)
	'
	vm.CreateAlert("a4", Me, "error").SetContent("I'm an error alert.").Show.AddToContainer(cont, 4, 1)
	Main.CreateVBCode(vue, "a4code", "Alert", $"vm.CreateAlert("a4", Me, "error").SetContent("I'm an error alert.").AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 4, 1)
	'
	...
	Main.CreateVBCode(vue, "a5code", "Alert", $"vm.CreateAlert("a5", Me, "").SetContent("I'm an alert.").SetIcon("mdi-material-design").SetBorder("top").SetColorIntensity(vm.COLOR_RED, vm.INTENSITY_LIGHTEN2).SetDark(True).AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 5, 1)
	'
	...
	Main.CreateVBCode(vue, "a6code", "Alert", $"vm.CreateAlert("a6", Me, "").SetContent("I'm an alert.").SetBorder("right").SetColorIntensity(vm.COLOR_BLUEGREY, vm.INTENSITY_LIGHTEN2).SetDark(True).AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 6, 1)
	'
	...
	Main.CreateVBCode(vue, "a7code", "Alert", $"vm.CreateAlert("a7", Me, "").SetContent("I'm an alert.").Show.SetIcon("mdi-vuetify").SetProminent(True).SetBorder("bottom").SetColorIntensity(vm.COLOR_PINK, vm.INTENSITY_LIGHTEN2).SetDark(True).AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 7, 1)
'	
	...
	Main.CreateVBCode(vue, "a8code", "Alert", $"vm.CreateAlert("a8", Me, "").Show.SetContent("You've got {B}5{/B} new updates on your timeline!.").SetIcon("mdi-twitter").SetDismissible(True).SetBorder("left").SetColoredBorder(True).SetOutlined(True).SetColor(vm.COLOR_CYAN).SetElevation(2).AddToContainer(cont, 1, 1)"$).AddToContainer(cont, 8, 1)
'	
	...
	Main.CreateVBCode(vue, "a9code", "Alert", $"vm.CreateAlert("a9", Me, "success").SetContent("I'm an alert.").SetBorder("top").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_RED, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 9, 1)"$).AddToContainer(cont, 9, 1)
	...
	Main.CreateVBCode(vue, "a10code", "Alert", $"vm.CreateAlert("a10", Me, "info").SetContent("I'm an alert.").SetBorder("right").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_BLUEGREY, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 10, 1)"$).AddToContainer(cont, 10, 1)

	vm.CreateAlert("a11", Me, "warning").SetContent("I'm an alert.").SetBorder("bottom").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_PINK, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 11, 1)
	Main.CreateVBCode(vue, "a11code", "Alert", $"vm.CreateAlert("a11", Me, "warning").SetContent("I'm an alert.").SetBorder("bottom").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_PINK, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 11, 1)"$).AddToContainer(cont, 11, 1)

	
	vm.CreateAlert("a12", Me, "error").SetContent("I'm an alert.").SetBorder("left").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_INDIGO, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 12, 1)
	Main.CreateVBCode(vue, "a12code", "Alert", $"vm.CreateAlert("a12", Me, "error").SetContent("I'm an alert.").SetBorder("left").SetColoredBorder(True).SetElevation(2).SetColorIntensity(vm.COLOR_INDIGO, vm.INTENSITY_LIGHTEN2).AddToContainer(cont, 12, 1)"$).AddToContainer(cont, 12, 1)
