...
Sub Code
	...
	'
	Dim cbo1 As VMComboBox = vm.CreateComboBox("cbo1", Me)
	...
	'
	Dim cbo4 As VMComboBox = vm.CreateComboBox("cbo4", Me)
	...
	'
	Dim cbo5 As VMComboBox = vm.CreateComboBox("cbo5", Me)
