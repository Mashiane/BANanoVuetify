...
Sub Code
	...
	'
	Dim echart1 As VMEChart = vm.CreateEchart("e1", Me).SetLineChart
	...
	'
	Dim echart4 As VMEChart = vm.createechart("e4", Me).SetLineChart
	echart4.SetArea
	...
	'
	Dim echart7 As VMEChart = vm.createechart("e7", Me).SetHistogram
	...
	'
	Dim echart8 As VMEChart = vm.createechart("e8", Me).SetHistogram
	...
	'
	Dim echart9 As VMEChart = vm.createechart("e9", Me).SetBarChart
	...
	'
	Dim echart10 As VMEChart = vm.createechart("e10", Me).SetBarChart
	...
	'
	Dim echart11 As VMEChart = vm.createechart("e11", Me).SetBarChart
	...
	'
	Dim echart13 As VMEChart = vm.createechart("e13", Me).SetPieChart
	...
	'
	Dim echart14 As VMEChart = vm.createechart("e14", Me).SetPieChart
	...
	'
	Dim echart15 As VMEChart = vm.createechart("e15", Me).SetPieChart
	...
	'
	Dim echart16 As VMEChart = vm.createechart("e16", Me).SetRingChart
	echart16.SetColumns(Array("date", "cost", "profit"))
	echart16.SetRows(pieD)
	cont.AddComponent(5, 1, echart16.tostring)
	'
	Dim echart17 As VMEChart = vm.createechart("e17", Me).SetRingChart
	...
	'
	Dim echart18 As VMEChart = vm.createechart("e18", Me).SetRingChart
	...
	'
	Dim echart19 As VMEChart = vm.createechart("e19", Me).SetFunnelChart
	echart19.SetColumns(Array("status", "value"))
	echart19.SetRows(funnelD)
	cont.AddComponent(6, 1, echart19.tostring)
	'
	Dim echart20 As VMEChart = vm.createechart("e20", Me).SetFunnelChart
	...
	'
	Dim echart21 As VMEChart = vm.createechart("e21", Me).SetFunnelChart
    ...
    '
	Dim echart22 As VMEChart = vm.createechart("e22", Me).SetMapChart
	echart22.SetColumns(Array("location", "GDP"))
	echart22.SetRows(mapD)
	cont.AddComponent(7, 1, echart22.tostring)
	'
	Dim echart23 As VMEChart = vm.createechart("e23", Me).SetMapChart
...
'	cont.AddComponent(8, 1, echart25.tostring)
	...
	'
	Dim echart31 As VMEChart = vm.createechart("e31", Me).SetGaugeChart
	...
	'
	Dim echart32 As VMEChart = vm.createechart("e32", Me).SetTreeChart
	...
	' vertical tree
	Dim echart34 As VMEChart = vm.createechart("e34", Me).SetTreeChart
