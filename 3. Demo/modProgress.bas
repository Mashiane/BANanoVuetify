...
Sub Code
	...
	pgIndex.CreateVBCode(vue, Me, "prg1code", "Progress", vue.GetSourceCode).AddToContainer(cont, 1, 1)
...
pgIndex.CreateVBCode(vue, Me, "prg2code", "Progress", vue.GetSourceCode).AddToContainer(cont, 1, 2)
...
vue.AddCode($""$)
pgIndex.CreateVBCode(vue, Me, "pl3code", "Progress", vue.GetSourceCode).AddToContainer(cont, 2, 1)
...
pgIndex.CreateVBCode(vue, Me, "pl4code", "Progress", vue.GetSourceCode).AddToContainer(cont, 2, 2)
...
vue.AddCode($""$)
pgIndex.CreateVBCode(vue, Me, "pl5code", "Progress", vue.GetSourceCode).AddToContainer(cont, 3, 1)
...
pgIndex.CreateVBCode(vue, Me, "pl6code", "Progress", vue.GetSourceCode).AddToContainer(cont, 3, 2)
...
pgIndex.CreateVBCode(vue, Me, "pl7code", "Progress", vue.GetSourceCode).AddToContainer(cont, 4, 1)
...
pgIndex.CreateVBCode(vue, Me, "pl8code", "Progress", vue.GetSourceCode).AddToContainer(cont, 4, 2)
...
pgIndex.CreateVBCode(vue, Me, "pc1code", "Progress", vue.GetSourceCode).AddToContainer(cont, 5, 1)
...
pgIndex.CreateVBCode(vue, Me, "pc2code", "Progress", vue.GetSourceCode).AddToContainer(cont, 5, 2)
...
vue.AddCode($""$)
pgIndex.CreateVBCode(vue, Me, "pc3code", "Progress", vue.GetSourceCode).AddToContainer(cont, 6, 1)
...
pgIndex.CreateVBCode(vue, Me, "pc4code", "Progress", vue.GetSourceCode).AddToContainer(cont, 7, 1)
...
vue.AddCode($"End Sub"$)
pgIndex.CreateVBCode(vue, Me, "pc5code", "Progress", vue.GetSourceCode).AddToContainer(cont, 7, 2)
