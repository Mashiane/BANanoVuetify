...
Sub PropertyBag_Card
	...
	'
	pbcard.AddHeading("e","Measurements")
	pbcard.AddHeightWidths("e")
	'
...
Sub Design_Card
	...
	sb.append($"${sparent}.AddControl(car${sname}.Card, bt${sname}.tostring, ${srow}, ${scol}, ${os}, ${om}, ${ol}, ${ox}, ${ss}, ${sm}, ${sl}, ${sx})"$)
	AddNewLine(sb)
	AddNewLine(sb)
	'
	'add events
