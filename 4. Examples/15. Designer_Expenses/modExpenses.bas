...
Sub Load_expensecategories
	...
	db.OpenWait("expenses", "expenses")
	'resultset variable
	Dim rsexpensecategories As BANanoAlaSQLE
	'initialize table for reading
	rsexpensecategories.Initialize("expensecategories", "catid")
	'generate & run command to select records
	rsexpensecategories.SelectAll(Array("catid","catname"), Array("catname"))
	rsexpensecategories.Result = db.ExecuteWait(rsexpensecategories.query, rsexpensecategories.args)
...
Sub Load_expensetypes
	...
	db.OpenWait("expenses", "expenses")
	'resultset variable
	Dim rsexpensetypes As BANanoAlaSQLE
	'initialize table for reading
	rsexpensetypes.Initialize("expensetypes", "typeid")
	'generate & run command to select records
	rsexpensetypes.SelectAll(Array("typeid","typename"), Array("typename"))
	rsexpensetypes.Result = db.ExecuteWait(rsexpensetypes.query, rsexpensetypes.args)
