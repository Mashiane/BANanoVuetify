...
Sub DeleteAll_Expenses
	...
	rsExpenses.FromJSON
	If rsExpenses.ok = False Then vm.ShowSnackBarError(rsExpenses.error)
...
Sub Load_expensecategories
	...
	rsexpensecategories.Initialize("expenses.db", "expensecategories", "catid", "expid")
...
Sub Load_expensetypes
	...
	'initialize table for reading
	rsexpensetypes.Initialize("expenses.db", "expensetypes", "typeid", "expid")
	'generate & run command to select records
	...
	If rsexpensetypes.ok = False Then vm.ShowSnackBarError(rsexpensetypes.error)
