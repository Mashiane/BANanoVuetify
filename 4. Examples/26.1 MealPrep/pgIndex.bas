...
Sub BuildDrawer
	...
	vm.Drawer.AddListItem(vm.CreateListItem("drwmenu", Me).SetItemTo("/menu").SetTitle("Menu"))
	vm.Drawer.AddListItem(vm.CreateListItem("drwprofile", Me).SetItemTo("/profile").SetTitle("Profile"))
	vm.Drawer.AddListItem(vm.CreateListItem("drwsignin", Me).SetItemTo("/signin").SetTitle("Sign In"))
