...
Sub Initialize
	...
	'
	Dim vf2 As VMElement = vm.vflex("").SetStatic(True)
	...
	'
	Dim vf3 As VMElement = vm.vflex("").SetStatic(True)
	...
	'set the template
	homedetails.SetTemplate(cont.tostring)
End Sub
