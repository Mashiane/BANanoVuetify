...
Sub Initialize
	...
	btnSignIn.AddAttributes(CreateMap("color":"primary", "@click": "registeruser", ":loading":"loading")).SetText("Register")
	...
	'register a method
	register.SetMethod(Me, "registeruser")
...
'define the callback
Sub registeruser(e As BANanoEvent)
